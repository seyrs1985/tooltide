...
- 基线(2026-09-26 R148 审计):394 工具页(i18n 口径);check_site 400 文件 31113 检查 0 失败;i18n 审计 394 页 321 键×9 语言;收入 $0.00(DEMO)。**规模口径以当轮 check_site 输出为准**(build 输出的页数与 STATUS 口径不同)。
