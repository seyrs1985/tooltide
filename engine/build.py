...
TOOL_EMOJI = {
 ...
 "stockavg": "📉", "possize": "🛡️", "lotto": "🎰", "pomodoro": "🍅", "passstrength": "🕵️", "cryptoprofit": "🚀", "petagedog": "🐶", "petagecat": "🐱", "flesch": "📚", "dewpoint": "🌫️", "btucalc": "❄️", "tire": "🚗", "hrzone": "❤️", "golf": "⛳", "bpmdelay": "🎧", "evcharge": "🔌", "goldenhour": "🌅", "pizza": "🍕", "inflation": "💸", "sleepdebt": "😴", "coffee": "☕️", "breakeven": "🚦", "idealweight": "⚖️", "lorem": "📝", "cagr": "📶", "pool": "🏊", "timespent": "⌛", "meattime": "🍖", "cardep": "🚙", "jetlag": "🌏", "paint": "🎨", "mulch": "🌿", "laminate": "📏", "wallp": "🖼️", "diapers": "🧷", "wake": "⏰", "formula": "🍼", "protein": "🥩", "creatine": "💊", "datausage": "📡", "flightdelay": "✈️", "subs": "📺", "silverval": "🥈", "yarn": "🧶", "caston": "🧢", "curtain": "🏠", "commute": "🚌", "mileage": "🧾", "carpool": "👥", "ebikerange": "🔋", "saddle": "🚲", "ebikecharge": "⚡", "tvsize": "📺", "fishtank": "🐠", "laundry": "👕", "movecost": "🚚", "boxcalc": "📦", "movetl": "📋", "heating": "🔥", "radiator": "🌡️", "insulation": "🧱", "firenum": "💰", "savingsrate": "📈", "coastfire": "🏖️", "tent": "⛺", "backpack": "🎒", "hiketime": "⛰️", "examplan": "📚", "flashcard": "🃏", "candy": "🍬", "partybudget": "🎉", "match401k": "🏦", "rentsplit": "🏘️", "giftbudget": "🎁", "charcoal": "🔥", "dogfood": "🐕", "catfood": "🐈", "treats": "🎾", "driptap": "🚰", "showerbath": "🚿", "standby": "🔌", "foodwaste": "🥬", "xmastree": "🎄", "carryon": "🧳", "stopdist": "🛑", "followdist": "🚗", "wintertire": "⛄", "plantwater": "🌱", "repot": "🌿", "fertdilute": "🧪", "turkeythaw": "🦃", "shipdead": "🚛", "leftover": "🍲", "skicost": "🎿", "skirent": "🏂", "skilength": "🏔️", "homework": "📓", "mattress": "🛏️", "aquaheat": "💡", "costperuse": "👖", "wishlist30": "🛒", "workhours": "⏳",
...
function queue(){
  ...
  if(window.requestAnimationFrame){
    ...
    // occluded/background tabs pause rAF, which would starve the spy forever
    // (every later scroll event sees pending===true) — a timer unblocks it
    window.setTimeout(function(){if(pending){pending=false;spy();}},80);
  } else spy();
}
...
function render(){
  var show=list.filter(function(x){return x.u!==here&&x.t;});
  if(show.length<2)return;
  var foot=document.querySelector('.site-foot');
  if(!foot)return;
  var label='Recently used';
  try{if(window.npT){var tr=window.npT('recent.title');if(tr&&tr!=='recent.title')label=tr;}}catch(e2){}
  var s=document.createElement('section');
  s.setAttribute('aria-label',label);
  s.style.cssText='max-width:920px;margin:0 auto 18px;padding:0 16px;font-size:.85rem;line-height:2.2';
  var html='<b style="opacity:.7">'+esc(label)+':</b> ';
  show.slice(0,5).forEach(function(x){
    html+='<a href="'+x.u+'" style="display:inline-block;margin:2px 8px 2px 0;padding:2px 12px;border:1px solid rgba(14,116,144,.35);border-radius:99px;text-decoration:none">'+esc(x.t)+'</a>';
  });
  s.innerHTML=html;
  foot.parentNode.insertBefore(s,foot);
}
if(window.npT)render();else if(document.addEventListener)document.addEventListener('DOMContentLoaded',render);else render();
}catch(e){}
})();</script>"""
