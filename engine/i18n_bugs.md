...
- 复验(2026-09-26)|case-converter|pt|case.resultlbl接线在服务HTML中实证(配合品牌更名R31同页验证ToolDune标识)|curl直连|已修R26-续+线上复验通过(R33待复核项之case页部分闭环;camelCase等4专名范围外维持)|所有译文语言|高频重复stat标签未接线TOP11(per month×4/total interest×3/you save×2/total paid×2/per year×2/per day×2/paintable area×2/full charge cost×2/day of year×2/cubic meters×2/words×2)|rg存量盘点|已修R20+部署(脚本化25处实例接lbl.permonth/peryear/perday+fin.totalinterest/totalpaid/yousave+paint.paintable+ev.fullcharge+date.dayofyear+conv.cubicmeters×10键×9语言,words复用既有wc.words;并行工作者卷带提交部署;长尾×1约300种留逐家族)
