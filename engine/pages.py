...
def PAGES():
    ...
    pages.append({'slug': 'dst-sleep-shift-planner', 'title': 'Daylight Saving Sleep Planner - When Clocks Fall Back and How to Shift', 'h1': 'Daylight Saving Sleep Planner', 'desc': 'Pick your region to see the exact fall-back date, then get a gentle bedtime shift plan - 10 to 20 minutes a day - so the time change lands without wrecking your week.', 'category': 'calculator', 'keyword': 'daylight saving time change fall back sleep schedule when do clocks go back', 'tool': 'dstsleep', 'args': {}, 'intro': ['Pick your region - the US and Canada fall back on the first Sunday of November, Europe on the last Sunday of October - and this planner shows the exact date, how far out it sits, and a bedtime shift schedule that moves your schedule 10 to 20 minutes a day so Sunday morning lands on purpose instead of in the dark.', 'The hour itself is not the problem; the drift is. Phones update themselves, the microwave does not, and small kids, pets and dawn commuters feel the change for days. The plan here is the standard pediatric-sleep approach scaled to your pace - and it ends with permission to take the spare hour as a gift.'], 'howto': ['Pick your region so the correct fall-back date is used.', 'Choose a pace you will actually keep - 15 minutes a day is the standard.', 'Start bedtime shifts on the date shown, and take Sunday hour as recovery.'], 'faqs': [('When do clocks fall back in 2026?', 'The US and Canada fall back on Sunday, November 1, 2026; most of Europe falls back on Sunday, October 25, 2026 - three weeks apart, which is why the region selector matters for travel plans.'), ('How do I prepare my body for the time change?', 'Move bedtime and wake time about 15 minutes later each day for the four nights before the change, keep morning light bright and evenings dim, and let Sunday morning absorb the spare hour.'), ('Why does falling back feel easier than springing forward?', 'You gain an hour instead of losing one, so the main cost is earlier darkness in the evening - but kids and pets still wake on clock time, which is why the gradual shift plan helps both directions.'), ('Do phones update for daylight saving time automatically?', 'Phones, laptops and most smart clocks do; ovens, microwaves, car dashboards and older thermostats do not - the planner note is to check the dumb clocks on the day.')]})
    pages.append({'slug': 'cooler-ice-calculator', 'title': 'Cooler Ice Calculator - Pounds of Ice by Guests, Hours and Weather', 'h1': 'Cooler Ice Calculator', 'desc': 'How much ice for the cooler? Guests times hours plus weather and food give pounds of ice, 10 lb bags to buy and the cooler size in quarts. Free, no sign-up.', 'category': 'calculator', 'keyword': 'how much ice for cooler calculator pounds per day tailgate', 'tool': 'coolice', 'args': {}, 'intro': ['Enter your guest count, how long the cooler holds, the weather, and whether food rides along. The calculator gives pounds of ice, the number of 10 lb bags to buy, and the cooler size in quarts that fits the load.', 'Cooler reviews argue about rotomolded walls while the actual failure is arithmetic: not enough ice for the hours and the heat. This one prices the real variables - and the free upgrades, pre-chilling and block ice, that outperform any premium shell.'], 'howto': ['Count guests and honest hours from first drink to pack-up.', 'Pick the weather band and say whether food shares the box.', 'Buy the bags figure rounded up, pre-chill the box, and pack blocks under cubes.'], 'faqs': [('How much ice do I need for a cooler per day?', 'About 6 lb per person per day of drinking covers the standard one-pound-per-four-hours rule - two people on a 12-hour tailgate day want 18-20 lb in warm weather. Food sharing adds half again, and anything over 29 C adds a quarter more.'), ('What size cooler for a tailgate?', 'Quarts roughly double the ice pounds: 20 lb of ice plus food wants a 40-50 qt box. Bigger is not better - an oversized, half-empty cooler melts ice faster because the air space is the enemy.'), ('Does block ice really last longer?', 'Yes - a block melts at roughly half the rate of cubes because less surface touches the air. Frozen water bottles are the cheap version: block ice that becomes cold drinking water instead of a soggy cooler floor.'), ('Should I pre-chill the cooler?', 'A warm cooler eats the first several pounds of ice just cooling its own walls. Thirty minutes of ice water dumped out before packing is the highest-return step in the whole routine - it is free and adds hours.')]})
    pages.append({'slug': 'tailgate-food-calculator', 'title': 'Tailgate Food Calculator - Meat, Sides and Drinks per Person', 'h1': 'Tailgate Food Calculator', 'desc': 'How much food for a tailgate? Adults, kids and meal style give pounds of raw meat, cups of sides and cans of drinks - a shopping list you can actually buy. Free, no sign-up.', 'category': 'calculator', 'keyword': 'tailgate food calculator how much meat per person drinks', 'tool': 'tailgatefood', 'args': {}, 'intro': ['Enter adults, kids, the meal style and hours in the lot. The calculator returns pounds of raw meat, cups of sides, and cans of drinks - the three lines of the shopping trip, sized to who is actually coming.', 'Party food advice speaks in vague handfuls, and tailgates punish vagueness: there is no corner shop at the stadium. The arithmetic here is the deli counter standard - half a pound of raw meat per adult - with honest dials for snack-only mornings and second-helping crowds.'], 'howto': ['Count adults and kids coming to the spread, not the invitation list.', 'Pick the meal style and hours out; drinks scale with both.', 'Buy the three numbers as given - and round the ice up on the cooler page.'], 'faqs': [('How much meat do you need per person for a tailgate?', 'Half a pound of raw meat per adult and a quarter per child is the standard, before cooking loss - six adults and two kids take 3.5 lb raw, about 2.6 lb cooked. Bone-in cuts like drumsticks need a third more weight for the same eating.'), ('How many drinks per person for a tailgate?', 'Two per person in the first hour and one each hour after - the first-hour rule. Eight adults out for four hours drink about 40 cans, which is why the calculator rounds to six-packs and lets the cooler page size the ice.'), ('How many sides should a tailgate have?', 'Two is the sweet spot: half a cup per person each, so a dozen eaters want 12 cups across both. One side feeds the meal and none feels like a stall - a third side mostly becomes landfill.'), ('How much food for a 6-hour tailgate?', "Food does not scale much with hours - people eat one meal, maybe seconds. Hours scale the drinks: at six hours, plan four cans per adult. The snack-only morning toggle covers the early kickoff when the meal is the stadium's problem.")]})
    pages.append({'slug': 'first-frost-planner', 'title': 'First Frost Planner - Winterize Schedule Working Back from Your Date', 'h1': 'First Frost Planner', 'desc': 'Enter your average first frost date and get the winterizing schedule working backward: last feeding, tender pots inside, final harvest, hose drain and frost-night covers. Free, no sign-up.', 'category': 'calculator', 'keyword': 'average first frost date 2026 when to bring plants inside fall', 'tool': 'frostplan', 'args': {}, 'intro': ['Enter the average first frost date for your town - the weather service and university extension tables publish one for everywhere - and this planner works backward from it: when to stop feeding, when tender pots come inside, when to make the final harvest, and what to do the last week.', 'Frost maps stop at the date and leave the work to guesswork. The date is only a drumbeat; the gardening is in the weeks before it, and every chore here has a reason - fertilizer feeds soft growth frost will kill, and the aphids on that pot ride indoors unless evicted first.'], 'howto': ['Look up your average first frost date and enter it - the planner rolls to next year once the date passes.', 'Put the three dates on your calendar; they are the whole job, weeks ahead of the cold.', 'Keep old sheets by the door for frost nights - covers buy tender beds two or three degrees.'], 'faqs': [('When should I bring potted plants inside for winter?', 'About four weeks before your average first frost - tender houseplants and tropicals stress when nights dip under 10 C. Earlier matters more than the date: a pest inspection and a water blast before the pot crosses the doorstep is what keeps your indoor collection clean.'), ('What is an average first frost date?', 'It is the long-run calendar date where frost has a 50 percent chance of having occurred by then - not a promise. Treat the date as a planning drumbeat; the actual first frost commonly lands within two weeks either side, which is why covers stay by the door.'), ('When do I stop fertilizing in fall?', 'Six weeks before first frost outdoors. Feeding pushes soft new growth that the first frost kills, wasting stored energy - the goal of late season is hardening, not growing. Houseplants coming indoors simply stop being fed until late winter.'), ('What vegetables survive a light frost?', 'Hardy crops - kale, cabbage, carrots, parsnips - improve after a light frost as starches turn to sugar. The tender list is the one the planner harvests two weeks out: basil, beans, cucumbers, peppers, tomatoes. One night at minus 1 C ends all of them.')]})
    pages.append({'slug': 'bulb-planting-calculator', 'title': 'Bulb Planting Calculator - How Many Bulbs Fit Your Bed', 'h1': 'Bulb Planting Calculator', 'desc': 'How many tulip or daffodil bulbs for your bed? Bed size times spacing gives the count, packs of 25 to buy, planting depth and spacing by bulb type. Free, no sign-up.', 'category': 'calculator', 'keyword': 'how many tulip bulbs per square foot bulb spacing depth calculator', 'tool': 'bulbspace', 'args': {}, 'intro': ['Enter your bed length and width, pick the bulb, and get the count to buy - bulbs per square foot from the spacing chart, packs of 25 rounded up, plus the planting depth and spacing for that bulb.', 'Planting charts answer per bulb; nobody plants one bulb. The real question at the garden centre till is how many bags a bed actually takes - and the honest answer comes from area arithmetic, not the optimistic picture on the bag.'], 'howto': ['Measure the bed length and width in feet - drifts and borders, not single rows.', 'Pick the bulb type; the chart carries depth and spacing for the five classics.', 'Buy the pack count, plant pointy end up at the depth shown, and water once.'], 'faqs': [('How many tulip bulbs per square foot?', 'About nine at the standard 4 inch spacing - a 4 by 8 bed takes roughly 290, or 12 packs of 25. Crowd them to 3 inch spacing for a dense display and the same bed wants 12 per square foot, but drainage and bulb food suffer in year two.'), ('How deep should I plant bulbs?', 'Two to three times the bulb height: tulips and daffodils 6 inches, crocus 3, giant alliums 6 with 8 inch spacing. Too shallow and frost heaves them; too deep and the shoot spends its budget getting to daylight.'), ('Do tulips need chilling before planting?', 'In warm climates yes - 12 to 16 weeks in the refrigerator, away from ripening fruit, because a tulip without its winter never forms a proper stem and blooms at knee height on a flop. Daffodils and crocus shrug off the lack.'), ('When should I plant fall bulbs?', 'October into November while soil is still workable - bulbs root best in cool soil and want roughly six weeks before the ground freezes. Planting into warm September soil invites rot; planting after freeze-up buries the season.')]})
    pages.append({'slug': 'christmas-cactus-bloom-planner', 'title': 'Christmas Cactus Bloom Planner - Start Long Nights 8 Weeks Before', 'h1': 'Christmas Cactus Bloom Planner', 'desc': 'Why is your Christmas cactus not blooming? Pick a target date and get the night to start the 13-hour darkness treatment, cool nights and dry watering that force buds. Free, no sign-up.', 'category': 'calculator', 'keyword': 'christmas cactus not blooming how to get blooms dark treatment weeks', 'tool': 'cactusbloom', 'args': {}, 'intro': ['Pick the date you want flowers - Christmas Day by default - and the planner counts back eight weeks to the night the long-dark treatment starts, with the three rules that actually move buds: 13 hours of total darkness, cool nights, and water only when dry.', 'The internet blames fertilizer for a budless cactus. Bloom here is triggered by night length and temperature - a photoperiod plant, same machinery as poinsettias - so the fix is a closet schedule, and the date arithmetic is the part everyone misses.'], 'howto': ['Enter your target bloom date; the planner hands the start night, rolling to next year if the window is gone.', 'From that night: 13 hours of unbroken darkness daily, cool nights, dry-ish watering, for eight weeks.', 'At pea-size buds, move to a bright window and never move the pot again.'], 'faqs': [('Why is my Christmas cactus not blooming?', 'Almost always light at night - a kitchen or living room used after dark gives the plant a summer that never ends. Thirteen hours of true darkness for eight weeks, with nights under 18 C, is the trigger; feed and repotting are side characters.'), ('How long is the Christmas cactus dark treatment?', 'Eight weeks of 13-hour nights, though buds often show by week four. Unbroken matters - even a lamp switched on for a minute resets the clock, which is why a closet or a cardboard box beats a dim corner.'), ('When do buds appear on a Christmas cactus?', 'Around four weeks into the treatment, as beads at the branch tips. From bud set onward the job changes: bright light, steady position, even watering - and no rotating the pot, which is the classic cause of buds dropping before they open.'), ('What temperature makes a Christmas cactus bloom?', 'Cool nights between 13 and 18 C do half the work - a plant on a warm windowsill with a radiator below can get perfect darkness and still stay green. Cool, dark and dry is the whole recipe; the flowers are the plant deciding winter came.')]})
    pages.append({'slug': 'space-heater-cost-calculator', 'title': 'Space Heater Cost Calculator - Per Hour, Day and Month', 'h1': 'Space Heater Cost Calculator', 'desc': 'What does a space heater cost to run? Wattage times hours times your electricity price gives the per-hour, daily and monthly cost - with the safety list. Free, no sign-up.', 'category': 'calculator', 'keyword': 'space heater cost per hour calculator 1500 watt running cost', 'tool': 'heatcost', 'args': {}, 'intro': ['Pick the heater wattage, hours per day and your electricity price. The calculator gives the cost per hour, per day and per 30-day month - a 1500 W heater burns 1.5 kWh every hour it runs, which adds up faster than most bills suggest.', 'Utility blogs print tables for their own tariffs. This one uses your price and your hours, then says the quiet part: electric resistance heat is the priciest kind, so the strategy is heating the room and the person - not competing with the whole-house thermostat.'], 'howto': ['Read the wattage off the heater label - 1500 W is the standard setting.', 'Enter honest hours: the evenings you actually sit in that room.', 'Take your price per kWh from the bill, and read the month figure sitting down.'], 'faqs': [('How much does a 1500 W space heater cost per hour?', 'At the typical 17 cents per kWh, about 26 cents an hour - 1.5 kWh times the tariff. Eight evening hours a day lands near 2 dollars, and a cold month of that habit approaches 60 dollars per heater.'), ('Is it cheaper to run a space heater or the furnace?', 'One heater heating one occupied room usually beats the furnace; three heaters running all day do not. The crossover is simple - the heater wins when you would otherwise heat empty rooms, and loses the moment it runs everywhere at once.'), ('Do space heaters use a lot of electricity?', 'Yes - 1500 W is comparable to a microwave that runs for hours. That is why the honest strategy is zone heating: close doors, heat the room you are in, and turn the central thermostat down while you do it.'), ('What are the space heater safety rules?', 'Three feet of clearance from anything flammable, never on an extension cord or power strip, on a hard level floor, switched off when you sleep or leave - and buy a unit with a tip-over switch, because space heaters head the home-fire statistics every single winter.')]})
    pages.append({'slug': 'generator-size-calculator', 'title': 'Generator Size Calculator - Running Watts Plus the Biggest Motor', 'h1': 'Generator Size Calculator', 'desc': 'What size generator do you need? Your running watts plus the largest motor surge give the right size in watts - with headroom and the two safety rules that outrank watts. Free, no sign-up.', 'category': 'calculator', 'keyword': 'what size generator do i need calculator running starting watts home', 'tool': 'gensize', 'args': {}, 'intro': ['Add up the running watts of what must stay on - fridge, lights, phone chargers, the furnace fan - then pick the biggest motor on the list. The calculator adds the starting surge, rounds to a real generator size, and shows the headroom figure that buys a longer engine life.', 'Generator dealers size you up to the biggest inverter on the lot. The physics is simpler: motors ask three times their running watts for a second when they start, and everything else is arithmetic. Size for the surge, not for the sales pitch.'], 'howto': ['List what must run in an outage and add the running watts from each label or the manual.', 'Pick the single biggest motor - fridge, sump pump, well pump or AC.', 'Buy the size shown, or the headroom figure if the budget allows.'], 'faqs': [('What size generator for a house fridge and lights?', 'A fridge (200 W running, 600+ starting) with lights, internet and phone charging lands around 2,000-2,500 W - the calculator adds your exact motor surge to your running total. That is inverter territory: quiet, clean power for electronics, sipping fuel.'), ('Why do motors need more watts to start?', 'An electric motor is briefly a stalled coil at switch-on, drawing two to three times its running current for under a second. A generator that cannot deliver that surge stalls - which is why the size is running watts plus the biggest motor, not just the sum of the labels.'), ('Should I buy a generator with headroom?', 'Yes if the budget allows: engines last longest around 80 percent load, headroom covers the appliance you forgot, and a lightly loaded big generator wastes fuel. The 25 percent figure shown is the sweet spot between those.'), ('Where should a portable generator run?', 'Outdoors only, at least 20 feet from any window or vent, exhaust pointed away - carbon monoxide kills quietly and quickly indoors, garages included. And connect appliances by cord or a transfer switch, never by backfeeding a wall outlet, which can electrocute the utility worker restoring your street.')]})
    pages.append({'slug': 'power-outage-food-calculator', 'title': 'Power Outage Food Calculator - Is the Fridge Still Safe?', 'h1': 'Power Outage Food Calculator', 'desc': 'How long is food safe when the power is out? Hours out, freezer fullness and the fridge door give the federal 4-hour and 48-hour verdict: keep it, toss the fridge, or bin the thawed. Free, no sign-up.', 'category': 'calculator', 'keyword': 'how long is food good in fridge without power power outage food safety hours', 'tool': 'outagefood', 'args': {}, 'intro': ['Enter how long the power was out, whether the freezer was full, and whether the fridge stayed shut. The calculator applies the federal food-safety lines - 4 hours for an unopened fridge, 48 for a full freezer, 24 for a half one - and returns one plain verdict.', 'Outage articles bury the numbers in paragraphs while you are standing in front of the fridge with a flashlight. This one is the chart as a decision: keep it all, clear the fridge, or bin everything thawed - with the refreeze rule and the when-in-doubt clause attached.'], 'howto': ['Enter the outage hours - round up, be honest about door openings.', 'Say how packed the freezer was; a full one simply holds cold longer.', 'Follow the verdict: ice-crystal food refreezes, warm or slimy never keeps.'], 'faqs': [('How long is food safe in the fridge without power?', 'About 4 hours unopened - that is the federal line for a fridge holding 4 C. Every opening trades cold air for room air, so after an hour of peeking treat the clock as done. Past 4 hours, meat, dairy, leftovers and cut fruit go to the bin without a sniff test.'), ('How long does a freezer keep food frozen without power?', 'A full freezer holds 48 hours, a half-full one 24 - a freezer packed with water jugs is the cheapest insurance going. Food that still has ice crystals can be refrozen safely; anything thawed to room temperature and held above 4 C is a toss.'), ('Can I refreeze food that thawed in an outage?', 'If it still has ice crystals and feels refrigerator-cold, yes - quality dips, safety holds. Anything slimy, warm, or ballooning its packaging is gone, and the rule that outranks all of them: when in doubt, throw it out. The groceries are cheaper than the hospital.'), ('What should I do to prepare the fridge for a storm?', 'Freeze water bottles tonight - they extend the hold and become drinking water. Group the freezer into a tight block so it self-insulates, know where the fridge thermometer sits, and skip the grocery run the day the storm lands: a half-empty fridge is a short clock.')]})
    pages.append({'slug': 'ups-runtime-calculator', 'title': 'UPS Runtime Calculator - How Long Will a UPS Keep You Powered?', 'h1': 'UPS Runtime Calculator', 'desc': 'Enter your UPS size, the load it carries and battery age to estimate real runtime in minutes - and why the VA badge lies while the battery decides. Free, no sign-up.', 'category': 'calculator', 'keyword': 'ups runtime calculator how long will a ups last', 'tool': 'upsruntime', 'args': {}, 'intro': ['Pick your UPS capacity, put in what it actually carries - a router and laptop pull around 80 watts, a desktop with monitors closer to 200 - and set the battery age. The estimate gives minutes of runtime, the power ceiling in watts, and how hard you are loading the unit.', 'Vendor pages quote half-load runtime on a new battery in lab conditions. This one uses the field model - consumer units carry roughly 0.15 Wh of battery per VA, about 85% deliverable, aging fast after year two - and says plainly that the goal for most setups is 5 to 10 clean minutes to save work and shut down, not to keep computing through the outage.'], 'howto': ['Pick the VA rating printed on the UPS; the watt ceiling is about 60% of it.', 'Enter the real load - add up the devices plugged in, not what you wish you had.', 'Set battery age honestly; over three years expect a third gone even with no use.'], 'faqs': [('How long will a 1000VA UPS run a router and laptop?', 'At about 80 watts combined, expect roughly 90 minutes from a healthy battery. The same unit at a 500 W desktop load drops to about 13 minutes - load, not the VA badge, sets the clock.'), ('Why does my UPS die in minutes when the box said longer?', 'The box quotes half-load runtime on a new battery. Batteries lose 20-30% of capacity by year three even unused, and loads creep up as devices accumulate - both shave the same curve.'), ('Should I buy a UPS sized for hours of runtime?', 'No - past 10-15 minutes each extra hour buys expensive battery banks and lithium conversions. The standard play is a short-run UPS on anything with unsaved work, and a generator or power station for duration.'), ('Do UPS batteries need replacing?', 'Every 3-5 years regardless of use - they age on the shelf. If the self-test beeps or runtime visibly halves, swap in the same spec; a fresh battery makes an old UPS genuinely new again.')]})
    pages.append({'slug': 'generator-fuel-calculator', 'title': 'Generator Fuel Calculator - Gallons and Cost for Your Outage', 'h1': 'Generator Fuel Calculator', 'desc': 'Generator size, load and outage hours give the burn rate, total gallons, cost and cans to fill - with the refueling and backfeed rules that keep you safe. Free, no sign-up.', 'category': 'calculator', 'keyword': 'generator fuel consumption calculator gallons per hour', 'tool': 'genfuel', 'args': {}, 'intro': ['Size the generator, pick how hard it will actually work - a fridge, lights and router sit near 25-50% on a 5000 W unit - and set the hours you want to cover. You get the burn rate per hour, total gallons, the cost at your pump price, and how many 5-gallon cans that means.', 'Dealer pages sell capacity and skip the fuel ledger entirely, yet fuel is what decides whether the generator is a tool or a porch ornament. The field rule - 0.18 gallons per hour per kilowatt at full load, scaled by your load - lands within a quarter of real tanks, and the page pairs it with the storage and refueling rules that prevent the classic storm-week mistakes.'], 'howto': ['Pick the generator size you own or are planning to buy or rent.', 'Be honest about load - most homes never average above 50%.', 'Set outage hours and your local gas price; the cans figure rounds up.'], 'faqs': [('How much gas does a 5000 watt generator use per day?', 'At a realistic 50% load, about 0.45 gallons per hour or 11 gallons a day - two and a bit 5-gallon cans. At 25% (fridge, lights, router) it falls to around 5-6 gallons; running everything at once can double it.'), ('How long can you store gasoline for a generator?', 'Three to six months untreated, a year or more with fuel stabilizer. Rotate the stock by pouring it into the car and refilling - an outage is the wrong time to discover last season went stale.'), ('Is a generator cheaper to run than a battery power station?', 'Per hour of heavy load, gasoline wins on cost. Per outage over years, the battery wins on silence, fumes, maintenance and indoor safety. The honest split: generators for multi-day whole-home events, stations for day-long rides and apartment use.'), ('Can I refuel a generator while it is running?', 'Never - a hot engine plus a spilled gallon is the textbook flash fire. Shut down, wait 10-15 minutes, refuel with a funnel, restart. Fifteen minutes of darkness is cheaper than the alternative.')]})
    pages.append({'slug': 'electric-vs-gas-heating', 'title': 'Electric vs Gas Heating Cost - Compare per Million BTU at Your Rates', 'h1': 'Electric vs Gas Heating Cost', 'desc': 'Your electric and gas prices, furnace efficiency and heat pump COP become one verdict in dollars per million BTU - the honest way to rank heating fuels. Free, no sign-up.', 'category': 'calculator', 'keyword': 'electric vs gas heating cost per btu comparison', 'tool': 'heatcmp', 'args': {}, 'intro': ['Put in what your bill actually charges per kWh and per therm, how efficient the furnace is, and the heat pump COP if you have one. Every option becomes a single number: dollars for one million BTU of delivered heat, the only fair way to compare fuels sold in different units.', 'Utility blogs compare sticker tariffs and call it done. This page divides by efficiency - an 80% furnace pays 25% more per heat unit than its nameplate, a COP 3 heat pump turns one purchased kWh into three of heat - and says out loud that delivery charges, not the fuel, often decide the verdict.'], 'howto': ['Use all-in rates from your latest bill, not the advertised generation rate.', 'Set furnace efficiency: 80% for older units, 95% for modern condensing.', 'Keep the COP at 3 unless you know your unit; deep cold pushes it lower.'], 'faqs': [('What is cheaper per unit of heat, electric or gas?', 'At US averages - 17 cents per kWh against $1.60 per therm - resistance electric costs about $50 per million BTU and gas about $17, so gas wins by roughly 3x. A heat pump at COP 3 brings electric down near $17 and usually takes the lead.'), ('Why compare heating in dollars per million BTU?', 'Electricity is sold in kWh, gas in therms, propane in gallons - raw prices cannot be ranked against each other. One million BTU is the same heat in every fuel, so dividing each price by its efficiency collapses the comparison into one number.'), ('Does furnace efficiency really change the math?', 'Yes: every dollar buys only 80-95 cents of heat depending on the unit, so an old furnace on a cheap tariff can cost more per heat than a modern one on a pricier tariff. The calculator prices this instead of trusting the nameplate.'), ('Is a heat pump worth it over a gas furnace?', 'On running cost the pump wins whenever its COP beats your normalized electric-to-gas price ratio - with COP 3 and typical US prices that is roughly break-even to cheaper, and it pulls ahead every time gas spikes, while also replacing the AC. Upfront install cost is the honest trade.')]})
    pages.append({'slug': 'hdhp-vs-ppo', 'title': 'HDHP vs PPO Calculator - Which Health Plan Wins on Total Cost', 'h1': 'HDHP vs PPO Calculator', 'desc': 'Premiums, deductibles, expected care and the employer HSA seed become one verdict: which plan wins this year and where the crossover sits. Free, no sign-up.', 'category': 'calculator', 'keyword': 'hdhp vs ppo which is better calculator', 'tool': 'hdhp', 'args': {}, 'intro': ['Pull both plans from your open-enrollment packet - your premium share, each deductible, what the employer seeds into the HSA - and take a straight guess at what this year of care costs you. The calculator totals each plan and shows the crossover point where the PPO takes over.', 'Plan-comparison charts stop at the premium difference and quietly bury the deductible gap. The honest model here is premiums plus costs up to each deductible minus free employer money - and it says plainly: a healthy year favors the HDHP, a planned surgery or a baby tips it hard, and the seed is yours to claim either way.'], 'howto': ['Copy each plan premium from the enrollment packet - your share, not the employer total.', 'Enter both deductibles and the employer HSA seed if the HDHP carries one.', 'Estimate expected care honestly - routine prescriptions and a dental visit, or a known procedure.'], 'faqs': [('When does the HDHP beat the PPO?', 'When premiums plus your expected costs stay under what the PPO would charge - typically for households with light, predictable care. The crossover in the calculator is the exact care level where the verdict flips at your numbers.'), ('Do HDHPs cover anything before the deductible?', 'Yes - since 2020, preventive care including annual physicals, vaccinations and certain screenings is covered before the deductible on HSA-qualified plans. Sick care is what waits behind the deductible.'), ('Is an HSA-qualified HDHP risky if something big happens?', 'The out-of-pocket maximum caps the damage, and tax-free HSA money - yours plus the employer seed - pays toward it. The bigger risk is cash flow: you need savings to front the deductible and be reimbursed later.'), ('Can I switch plans every year?', 'Yes - open enrollment resets annually, and job changes or qualifying life events allow mid-year switches. Re-running this comparison each fall with fresh premiums is the whole game.')]})
    pages.append({'slug': 'fsa-calculator', 'title': 'FSA Calculator - Tax Savings, Per-Paycheck Cost and Use-or-Lose Risk', 'h1': 'FSA Calculator', 'desc': 'Your FSA election becomes real tax saved at your bracket plus payroll tax, the per-paycheck dent, and exactly how much sits at use-or-lose risk. Free, no sign-up.', 'category': 'calculator', 'keyword': 'fsa calculator tax savings use or lose', 'tool': 'fsa', 'args': {}, 'intro': ['Set your election, your tax bracket, how many paychecks a year you get, and what you realistically plan to spend on eligible care. The calculator shows the true tax saving - income tax plus the 7.65% payroll tax FSA money skips - and the amount riding on use-or-lose.', 'Employer flyers sell the FSA as free money and skip the forfeit math entirely. This one prices both sides: the bracket-plus-payroll saving stacking in your favor, and the grace-period or carryover rules deciding what happens to whatever is left on December 31.'], 'howto': ['Election first: the 2026 ceiling is $3,400 unless your employer caps lower.', 'Pick your marginal bracket from your last pay stub - that is the income tax slice.', 'Enter planned expenses honestly; the risk figure is what forfeits if plans change.'], 'faqs': [('How much does an FSA actually save in taxes?', 'Your contribution times your bracket plus 7.65% payroll tax - about 29.6% total at the 22% bracket. On a $2,600 election that is roughly $770 that would otherwise have been taxed away.'), ('What happens to unused FSA money?', 'Use-or-lose forfeits it at year end, with two softeners - plans offer either a 2.5-month grace period to spend into March, or a carryover of up to $660 into next year. Check which one yours runs; employers pick one.'), ('What can I spend FSA money on?', 'Medical, dental, vision, prescriptions, therapy copays, glasses and contacts, braces, band-aids, sunscreen over SPF 15. Gym memberships and general wellness never qualify - the IRS list is narrower than people hope.'), ('Is an FSA better than an HSA?', 'They rarely coexist: the FSA is spend-this-year, the HSA is save-forever, and an FSA generally blocks HSA contributions. If your plan is HSA-qualified, the HSA wins for anyone who can leave money untouched; the FSA suits known, recurring care.')]})
    pages.append({'slug': 'hsa-contribution-calculator', 'title': 'HSA Contribution Calculator - 2026 Limits, Tax Savings and the Cap', 'h1': 'HSA Contribution Calculator', 'desc': 'The 2026 HSA limits by coverage and age, your real tax saving with payroll tax skipped, and a warning the moment you cross the cap. Free, no sign-up.', 'category': 'calculator', 'keyword': 'hsa contribution calculator 2026 limits', 'tool': 'hsa', 'args': {}, 'intro': ['Pick your coverage, enter your age and what you plan to contribute. The calculator shows the 2026 cap - $4,400 self-only, $8,750 family, plus $1,000 catch-up at 55 or older - the tax saving with payroll tax included, and an over-contribution warning before the IRS charges you for it.', 'Bank pages quote last year and stop there. This one prices the full stack - bracket plus the 7.65% payroll tax that payroll contributions skip - and nags about the 6% excise tax on the overshoot, the part the enrollment emails never mention.'], 'howto': ['Match coverage to your HDHP - self-only or family - and add the catch-up at 55+.', 'Enter your planned contribution and bracket from your pay stub.', 'Contribute through payroll when possible; that is what skips the payroll tax too.'], 'faqs': [('What are the 2026 HSA contribution limits?', '$4,400 for self-only coverage, $8,750 for family, plus a $1,000 catch-up for anyone 55 or older - the catch-up counts inside your own contribution. Employer seed money shares the same cap.'), ('What happens if I over-contribute?', 'The excess earns a 6% excise tax every year it stays, on top of ordinary tax at withdrawal. Fix it by pulling the excess plus earnings before the filing deadline, or by reducing next year cap-room.'), ('Why do people call the HSA triple tax free?', 'Contributions skip income tax, growth is untaxed, and withdrawals for qualified medical care are untaxed at any age - no other account stacks all three. After 65 it behaves like a traditional IRA for non-medical spending.'), ('Should I spend HSA money now or save receipts?', 'If cash flow allows, pay care costs out of pocket and bank the receipts - the account grows untaxed and qualified withdrawals can be reimbursed decades later. That is the compounding engine most HSA owners never start.')]})
    pages.append({'slug': 'social-security-break-even-calculator', 'title': 'Social Security Break Even Calculator - Claim at 62, 67 or 70?', 'h1': 'Social Security Break Even Calculator', 'desc': 'Your birth year and benefit estimate become the real monthly check at each claiming age - with the 62-vs-70 break-even age and the earnings-test warning. Free, no sign-up.', 'category': 'calculator', 'keyword': 'social security break even calculator claim at 62 or 70', 'tool': 'ssclaim', 'args': {}, 'intro': ['Enter your birth year and the benefit estimate from your SSA statement, then pick a claiming age. The calculator applies the actual reduction and credit formulas - 5/9 and 5/12 of a percent per early month, 2/3 of a percent per delayed month - and shows your real monthly check.', 'Most claiming articles stop at wait-as-long-as-you-can. This one shows the break-even age where waiting wins on raw totals - around 80 for the 62-versus-70 question - and then says the quiet part: health, cash need and the earnings test decide more than the spreadsheet does.'], 'howto': ['Birth year sets your full retirement age - 67 for anyone born 1960 or later.', 'Use the monthly estimate from your ssa.gov statement, not a guess.', 'Slide the claiming age and watch the note flip between cut, par and credit.'], 'faqs': [('What is the Social Security break even age?', 'For claiming at 62 versus 70, monthly checks cross in the early 80s: the smaller early check accumulates until the larger late check catches up. Live past it, waiting paid more; die before it, claiming early did. That is why health is the first input, not the last.'), ('How much do I lose if I claim at 62?', 'With a full retirement age of 67, claiming at 62 cuts the check by 30% - permanently. The base never recovers, and every future cost-of-living adjustment applies to the smaller figure, so the gap widens in dollar terms over time.'), ('How much do delayed retirement credits add?', 'Two-thirds of a percent per month past full retirement age, up to age 70 - 8% per year, or 24% more per month for waiting from 67 to 70. Credits stop at 70; claiming later never helps.'), ('Can I work while collecting early?', 'Yes, but the earnings test withholds $1 for every $2 earned above the annual limit before full retirement age. The money is not lost - it is credited back at full retirement age - but the cash flow surprises people every year.')]})
    pages.append({'slug': 'thanksgiving-dinner-cost-calculator', 'title': 'Thanksgiving Dinner Cost Calculator - Total and Per Guest', 'h1': 'Thanksgiving Dinner Cost Calculator', 'desc': 'Guests, turkey price and sides style become a total dinner bill, a per-guest figure and the exact turkey weight to buy. Free, no sign-up.', 'category': 'calculator', 'keyword': 'thanksgiving dinner cost per person calculator', 'tool': 'thankcost', 'args': {}, 'intro': ['Set your guest count, the turkey price at your store, a sides style and the drinks budget. The calculator totals the bill, splits it per guest, and tells you the turkey weight to actually buy at 1.5 pounds per person.', 'Supermarket flyers quote a per-guest average that fits nobody. This one prices your table - and points out that sides quietly match the bird, frozen turkeys get cheap after the panic week, and assigning two sides to guests cuts a fifth off the bill invisibly.'], 'howto': ['Count everyone at the table, including the cousin who only eats rolls.', "Check your store's price per pound - frozen birds run cheaper than fresh.", 'Pick the sides style honestly; the potluck move is always available.'], 'faqs': [('How much turkey do I need per person?', '1.5 pounds uncooked per guest - it sounds huge, but bones, shrinkage and the strategic leftovers requirement eat most of it. A 15-pound bird comfortably feeds 10 with sandwich stock for the weekend.'), ('What is the average cost of Thanksgiving dinner?', 'National surveys land around $60-90 for a 10-person table, but the honest range is huge: geography, sides style and whether dessert is homemade swing it double. The calculator prices your actual cart instead of a national average.'), ('How do I cut Thanksgiving costs without anyone noticing?', 'Three moves: buy frozen early (prices drop after the panic week), run the potluck play with two sides assigned to guests, and make the drinks section self-serve. Nobody remembers the cranberry sauce brand.'), ('When should I start thawing the turkey?', 'Fridge thawing takes about 24 hours per 4-5 pounds, so a 15-pound bird starts five days out. The turkey thaw planner on this site builds the exact schedule from your dinner time.')]})
    pages.append({'slug': 'roth-vs-traditional-401k', 'title': 'Roth vs Traditional 401k Calculator - Which Wins After All Taxes', 'h1': 'Roth vs Traditional 401k Calculator', 'desc': 'Same growth, different tax year: see the final after-tax value of Roth versus Traditional at your rates, and why the verdict reduces to one question. Free, no sign-up.', 'category': 'calculator', 'keyword': 'roth vs traditional 401k calculator which is better', 'tool': 'rothtra', 'args': {}, 'intro': ['Enter your annual contribution, your tax bracket now, your expected bracket in retirement and the years to grow. The calculator compounds both paths at 7% and shows the final after-tax value of each - Roth grows tax-free, Traditional deducts now and taxes at the end.', 'Most comparison pages bury the punchline: with identical growth, the entire verdict collapses to whether your tax rate is higher today or in retirement. This one shows the math collapsing to exactly that - and then says honestly that nobody knows their retirement rate, which is why split contributions are the rational default.'], 'howto': ['Set the contribution you can actually sustain every year.', 'Pick your bracket from your pay stub; pick the retirement bracket honestly.', 'Watch the gap change as the retirement-rate guess moves - that is the real lesson.'], 'faqs': [('Which is better, Roth or Traditional 401k?', 'Whichever comes with the lower tax rate: contribute and deduct at a high rate now (Traditional) or pay tax now and withdraw tax-free later (Roth). If the rates were identical they would tie exactly - every dollar of difference in the calculator comes from the rate gap.'), ('Should young investors choose Roth?', 'Usually yes - early-career brackets are the lowest of a working life, so buying tax-free growth at a 12% rate and withdrawing at 22%+ is a good trade. The calculator shows the same logic quantified: low rate now, Roth wins.'), ('Does the employer match count for Roth?', 'By default employer match lands pre-tax (Traditional side) regardless of your election, though plans increasingly allow Roth match. Either way the match itself is a 50-100% instant return - never leave it, whatever the flavor.'), ('Can I split between Roth and Traditional?', 'Yes, in the same plan, in the same year - and it is the honest strategy when the future rate is unknown. Splitting builds tax diversification: withdrawals can be balanced across taxable, Traditional and Roth buckets in retirement.')]})
    pages.append({'slug': 'tire-pressure-temperature-calculator', 'title': 'Tire Pressure Temperature Calculator - How Much PSI the Cold Takes', 'h1': 'Tire Pressure Temperature Calculator', 'desc': 'The first cold night costs your tires real PSI - see the exact loss, what the gauge should read today, and why the TPMS light loves November mornings. Free, no sign-up.', 'category': 'calculator', 'keyword': 'tire pressure drop temperature calculator cold weather psi', 'tool': 'tiretemp', 'args': {}, 'intro': ['Enter the placard pressure from your door sticker, today temperature, and the cold night in the forecast. The calculator applies the gas law to your tires and gives the PSI you will lose, the gauge reading to set today, and what you would wake up to if you do nothing.', 'Forum threads argue about the 1-PSI-per-10-degrees rule while the math is sitting right there: pressure scales with absolute temperature. This calculator does the exact version for your numbers - and explains why you should never bleed a warm tire down to the placard figure.'], 'howto': ['Read the placard on the driver door jamb, not the tire sidewall max.', 'Enter the current temperature and the cold low in the forecast.', 'Add the shown PSI today so the placard number holds on the cold morning.'], 'faqs': [('How much does tire pressure drop in cold weather?', 'About 1 PSI for every 10 degrees F drop - roughly 3 PSI for a 30-degree overnight. At typical 33 PSI placards that is close to 10% of your pressure, which is exactly where TPMS warnings begin for marginal tires.'), ('Why did my TPMS light come on in the morning?', 'Overnight cold pulled the pressure below the 25%-under-placard trigger. Driving warms the tires and the light often quits - the system is not broken, your tires are genuinely softer on cold mornings. Top up to placard.'), ('Should I overinflate tires for winter?', 'No - set placard pressure measured cold. The calculator shows how much to add so the placard number holds in the cold. Overinflating past it shrinks the contact patch and hurts braking on the exact surfaces you are worried about.'), ('Is the 1 PSI per 10 degrees rule accurate?', 'It is a good rule of thumb near passenger-car pressures; the calculator runs the exact gas-law ratio for your numbers and temperatures, which drifts from the rule at extreme cold or high pressures like light-truck ratings.')]})
    pages.append({'slug': 'antifreeze-mix-calculator', 'title': 'Antifreeze Mix Calculator - Concentrate, Water and Freeze Protection', 'h1': 'Antifreeze Mix Calculator', 'desc': 'Cooling system capacity plus target mix gives quarts of concentrate and distilled water - with the freeze chart and the 70% trap the shelf never mentions. Free, no sign-up.', 'category': 'calculator', 'keyword': 'antifreeze mix ratio calculator coolant water', 'tool': 'antifreezemix', 'args': {}, 'intro': ['Enter your cooling system capacity (in the owner manual or a search away) and pick a target mix. The calculator splits it into quarts of glycol concentrate and distilled water, shows the freeze protection, and converts to 50/50 pre-mix gallons if you would rather buy convenience.', 'Parts-store pages sell concentrate and stop there. This one prices the two honest traps: above 70% concentrate, protection and heat transfer both get worse - more is not more - and mixing chemistry families gels the coolant into a raid-the-hazard situation.'], 'howto': ['Find system capacity in quarts from the manual or filler-neck label.', 'Pick the target mix for your coldest realistic night, not the record low.', 'Buy distilled water; never mix coolant colors you cannot identify.'], 'faqs': [('What is the best antifreeze-to-water ratio?', '50/50 protects to about -34 F and moves heat well - the universal default. Colder climates run 60% for protection near -62 F; milder ones can run 40%. Above 70% both protection and cooling get worse, which surprises almost everyone.'), ('Can I use 100% antifreeze in my radiator?', 'You should not - straight glycol freezes around -37 F, warmer than a 60% mix, and carries heat noticeably worse. The water fraction is not filler; it is half the working fluid.'), ('Is tap water okay to mix with antifreeze?', 'Distilled is the standard - tap water brings minerals that scale the passages and shorten water-pump life. In an emergency on the roadside, tap water beats walking; flush it back to spec when you get home.'), ('How do I know what coolant is already in the car?', 'Color is a hint, not a promise - green is traditionally IAT, orange/pink/blue are OAT or hybrid families. If the history is unknown, test strips cost a few dollars or do a full flush; never top a system with a different chemistry family.')]})
    pages.append({'slug': 'car-battery-cold-test', 'title': 'Car Battery Cold Weather Test - Will It Start Tomorrow Morning?', 'h1': 'Car Battery Cold Weather Test', 'desc': 'Battery age, your climate history and the overnight low give the starting power left, the cold-cut capacity curve and a plain verdict: start, test, or replace. Free.', 'category': 'calculator', 'keyword': 'car battery cold weather test will my battery start', 'tool': 'batterycold', 'args': {}, 'intro': ['Enter the battery age from the label sticker, the overnight low in the forecast, and whether your summers run hot. The estimate stacks the temperature capacity curve with age wear and gives a percentage of rated starting power - plus a plain verdict.', 'Tow-truck dispatcher pages explain cold after the fact. This one explains the deal in advance: heat all summer quietly ages the plates, cold exposes what is left - at 0 F a battery holds about 40% of rated power while the engine needs twice the torque to spin.'], 'howto': ['Read the age from the date code sticker on the battery case.', 'Enter the forecast low for the next cold night.', 'Marginal verdict means get the free parts-store load test this week, not eventually.'], 'faqs': [('Why do car batteries die in cold weather?', 'They were already dying - summer heat boils off fluid and corrodes the plates, and the first cold morning collects the debt: available cranking power falls to roughly 65% at freezing and 40% at 0 F while cold oil makes the engine harder to crank. The failure looks sudden; the slide was all season.'), ('How long should a car battery last?', 'Three to five years in hot climates, five to seven in cold ones - heat is the killer, which is why the calendar depends on where you park. Past four years, a fall load test turns a surprise into a scheduled errand.'), ('How can I test my battery at home?', 'Headlights on a cold morning are the folk test - bright that dim when cranking means marginal. The real answer is a load test: every major parts store runs one free in minutes, no purchase required, and it measures what the folk test guesses.'), ('Can a battery be fine but fail in the cold?', 'That is the normal pattern - it cranks fine at 60 F with half its capacity gone, because warm engines barely ask anything of it. Capacity is relative; the cold snaps the balance. The calculator shows both sides of that ledger for your numbers.')]})
    pages.append({'slug': 'christmas-lights-cost-calculator', 'title': 'Christmas Lights Cost Calculator - LED vs Incandescent Season Bill', 'h1': 'Christmas Lights Cost Calculator', 'desc': 'Strings, hours and your electric rate become the real season bill - and the exact dollar figure an LED swap saves before you climb the ladder. Free, no sign-up.', 'category': 'calculator', 'keyword': 'christmas lights electricity cost calculator led vs incandescent', 'tool': 'lightcost', 'args': {}, 'intro': ['Count your strings, pick the bulb type - mini incandescent pulls 40 watts a string, mini LED about 5, and the big C9s run 175 versus 25 - then set hours per night and your electric rate. The season bill lands in dollars, with the LED-swap saving right next to it.', 'Retailer pages sell strings and skip the meter. This one prices the display honestly: LED pays for itself in one to two seasons at six hours a night, three-strings-per-plug is a hard rule for old C9s, and a ten-dollar timer answers the question nobody wants to climb the ladder to ask.'], 'howto': ['Count every string going up, including the ones in the attic you forgot.', 'Match the type - the wattage per string is printed near the plug.', 'Set the timer hours honestly; six is the national habit.'], 'faqs': [('How much does it cost to run Christmas lights?', 'Six mini LED strings at 6 hours a night for 45 days cost well under 2 dollars at typical rates. The same count in old mini incandescents runs about 8 times that, and C9 incandescents make the meter spin like a small space heater.'), ('Do LED Christmas lights really save money?', 'Yes - roughly 85-90% less electricity per string, plus they run cool so they last many seasons. The payback on the price difference is typically one to two seasons of evening display use.'), ('How many Christmas light strings can I connect?', 'Incandescent: three strings maximum end-to-end on one circuit run - that is the printed safety limit, not a suggestion. LED: read the box, most allow more because the current is tiny and the strings stay cool.'), ('Why did half my light string go dark?', 'On incandescent sets, a single dead bulb or the little plug fuse breaks the circuit for everything downstream - check the fuse door in the plug first, then the bulbs nearest the dark section. LEDs fail per-bulb; the rest stay lit.')]})
    pages.append({'slug': 'furnace-filter-calculator', 'title': 'Furnace Filter Calculator - Size Decoder, Yearly Cost and MERV Honesty', 'h1': 'Furnace Filter Calculator', 'desc': 'Decode the size on the frame, price a year of filters at your change interval, and get the MERV answer without the filtration-fear upsell. Free, no sign-up.', 'category': 'calculator', 'keyword': 'furnace filter size replacement schedule merv calculator', 'tool': 'furnfilter', 'args': {}, 'intro': ['Type the size printed on your current filter frame, pick how often you will actually change it, and set the price per filter. You get the yearly cost, the next change date, and a straight answer on MERV ratings.', 'The filter aisle sells fear in both directions - premium MERV 13 for everyone, or 1-dollar fiberglass that filters almost nothing. The honest version: MERV 8 for dust, 11 for pets and allergies, 13 only if your system is rated for the airflow drag, which otherwise arrives on your bill as longer runtimes.'], 'howto': ['Read the nominal size off the frame edge - numbers like 16x25x1.', 'Set the interval honestly; peak heating season is usually 30 days for 1-inch filters.', 'Check the lamp test monthly: no light through the filter means change it now.'], 'faqs': [('What size furnace filter do I need?', 'The nominal size printed on your current filter frame - something like 16x25x1. The actual frame is about half an inch smaller on each side; buy by the nominal number and the cardboard edge compresses to seal. If the print is gone, measure the slot and round up to the nearest nominal size.'), ('How often should I change my furnace filter?', 'Every 30 days in peak heating or cooling season, 60-90 in shoulder months for 1-inch filters. Pets, wildfire smoke and a dusty renovation shorten it. The calendar is a floor - hold it up to a lamp and let your eyes make the call.'), ('What MERV rating should I use?', 'MERV 8 for most homes, MERV 11 with pets or allergies, MERV 13 only if the system manual says it can breathe through one. Higher ratings catch smaller particles but fight the blower, and the cost shows up as longer runtimes, not on the filter price tag.'), ('What happens if I never change the filter?', 'Airflow drops, the blower works harder, the heat exchanger runs hotter, and in the worst case the limit switch starts short-cycling the furnace. It is the cheapest maintenance in the house and the most common cause of no-heat calls in January.')]})
    pages.append({'slug': 'humidifier-size-calculator', 'title': 'Humidifier Size Calculator - Gallons Per Day for Your Room', 'h1': 'Humidifier Size Calculator', 'desc': 'Room area, ceiling height and how leaky the room is give the gallons-per-day rating to shop for - plus winter electricity and honest tank-refill math. Free, no sign-up.', 'category': 'calculator', 'keyword': 'humidifier size calculator room square feet gallons', 'tool': 'humidsize', 'args': {}, 'intro': ['Enter the room area, ceiling height and whether the room leaks air - old windows breathe a lot, new builds barely. The calculator gives the gallons-per-day output to shop for, the tank class on the shelf, and how many refills a day that really means.', 'Box ratings assume a sealed room with the windows shut. This one prices reality: leaky rooms need a third more capacity, ultrasonic units dust everything with minerals unless you run distilled, and past 40 percent humidity the windows start sweating - the built-in humidistat beats any timer.'], 'howto': ['Measure the room the humidifier will actually live in, not the whole floor.', 'Be honest about the leakiness - drafty sash windows change the answer.', 'Shop the tank class, then check the refill width: one gallon a day is a jug a day.'], 'faqs': [('What size humidifier do I need for my room?', 'Roughly 1 gallon per day for 300 square feet, scaling with ceiling height and air leaks. A leaky 400-square-foot bedroom can need double the rating of a tight one - the calculator prices the leaks instead of ignoring them.'), ('What humidity should my house be in winter?', '30 to 40 percent. Below that, static shocks and dry throats; above it, condensation on the windows and mold risk in the corners. That ceiling is why the humidistat matters more than the run time.'), ('Why does my ultrasonic humidifier leave white dust?', 'The mist carries whatever is in the water - hard tap water means fine mineral dust on every surface. Distilled water stops it completely; evaporative wick units do not have this problem because the minerals stay in the wick.'), ('Do humidifiers use a lot of electricity?', 'No - even a whole-room unit draws less than a couple of old light bulbs, typically a few dollars over an entire winter. The real cost is the water jugs and the filter wicks, which is where the refill math earns its place.')]})
    pages.append({'slug': 'daylight-hours-calculator', 'title': 'Daylight Hours Calculator - Day Length by Date and Latitude', 'h1': 'Daylight Hours Calculator', 'desc': 'Any date plus your latitude gives the exact day length, the seasonal longest and shortest, and minutes gained or lost per day - with the winter-light honesty note. Free.', 'category': 'calculator', 'keyword': 'daylight hours calculator day length by date', 'tool': 'daylight', 'args': {}, 'intro': ['Pick a date and set your latitude - 40 is about the US average. The calculator runs the sun geometry and returns the day length, the longest and shortest days at your latitude, and how many minutes a day you are gaining or losing right now.', 'Sunrise-sunset tables bury the number people actually want: how much light the day holds, and how fast it is leaving. This one answers that - and says the quiet part about under-ten-hour days: the best-evidenced fix for the winter blues is morning outdoor light, not the desk lamp.'], 'howto': ['Set the date you are curious about - today is preloaded.', 'Set latitude: about 40 for the US mid-band, 51 for London, 66 is the Arctic Circle.', 'Watch the per-day change flip sign at the solstices.'], 'faqs': [('How many hours of daylight in winter?', 'It depends almost entirely on latitude: at 40 degrees north the shortest day runs about 9 hours 20 minutes; at 50 degrees (Frankfurt, Winnipeg edges) it drops under 8; inside the Arctic Circle the sun never rises. The calculator gives your exact figure.'), ('How fast do we lose daylight in fall?', 'The steepest losses sit near the equinox - around 3 minutes a day at 40 degrees north, faster the further north you go - slowing to zero at the solstice. Daily it is invisible; over October it adds up to nearly an hour and a half.'), ('Does daylight saving time change daylight hours?', 'No - it moves an hour of light from morning to evening (or back). The sun gives the same day length either way; only the clock labels shift. That is why the sleep-shift plan and the daylight math are separate questions.'), ('Why is my sunrise table a few minutes off this result?', 'Day length as computed here uses pure geometry; real sunrise tables add atmospheric refraction and the solar disc radius, stretching the day by several minutes at the edges. For planning your daylight, the geometry is the honest middle.')]})
    pages.append({'slug': 'holiday-tipping-calculator', 'title': 'Holiday Tipping Calculator - Year-End Budget Split by Recipient', 'h1': 'Holiday Tipping Calculator', 'desc': 'Your year-end tipping budget splits across weekly regulars and occasional helpers - with the USPS cap, the teacher rules and the frequency-beats-warmth principle. Free, no sign-up.', 'category': 'calculator', 'keyword': 'holiday tipping guide calculator how much to give', 'tool': 'holidaytip', 'args': {}, 'intro': ['Set your total budget and count who is actually on the list - weekly regulars like a cleaner or dog walker, occasional helpers like a hairdresser or sitter. The calculator splits it on the classic rule: weekly people take about 60 percent, one-visit fee as the benchmark.', 'Greeting-card tipping guides list everyone equally and leave you guilty. This one prices the real hierarchy - frequency beats warmth: the person who showed up every week outranks everyone you met twice - and prints the three caps the cards never mention: USPS cash limits, school-district teacher rules, and the super who fixed nothing.'], 'howto': ['Set a total you can afford first - guilt is not a budget line.', 'Count weekly regulars and occasional helpers honestly.', 'Read the caps note before you hand anyone an envelope.'], 'faqs': [('How much should I tip my house cleaner for the holidays?', 'The standard is one full visit fee, or a week of service for long-standing weekly arrangements - whichever your budget runs to. If cost splits a year of goodwill, a sincere note plus a smaller envelope beats silence.'), ('Can I tip my mail carrier?', 'Not in cash beyond 20 dollars - USPS employees may not accept money gifts, per federal rules. A gift card under the limit, or snacks and a note, are the compliant route. The same cap-and-gift-card logic applies to many public employees.'), ("Should I give my child's teacher a gift?", 'Check the district first - many bar cash gifts entirely. The safe play is a small gift card plus a note about something specific they did, or classroom supplies. The handwritten note from your child outperforms every envelope.'), ('Who do I tip when the budget is tight?', 'Rank by frequency and dependence: the people who came weekly all year first, then anyone who handled something hard for you, then everyone else gets a card. A smaller gift to the right person beats an even spread that says nothing to anyone.')]})
    pages.append({'slug': 'donation-deadline-calculator', 'title': 'Donation Deadline Calculator - Real Cost, Tax Math and December 31', 'h1': 'Donation Deadline Calculator', 'desc': 'Your gift amount and bracket give the real after-tax cost, the days left this year, and the receipt rules - plus the bunching move most filers never hear about. Free.', 'category': 'calculator', 'keyword': 'charitable donation tax deduction deadline calculator', 'tool': 'donate', 'args': {}, 'intro': ['Enter what you plan to give and your tax bracket. The calculator shows the tax saved if you itemize, the real after-tax cost of the gift, the days left before the December 31 deadline, and the receipt rule that applies at your amount.', 'Year-end giving posts push urgency and skip the fine print. This one leads with the honest headline - since the standard deduction doubled, most filers get no deduction at all - then prices the real levers: bunching two years of giving into one December, swiping the card before midnight, and donating appreciated stock even at modest amounts.'], 'howto': ['Set the amount and your marginal bracket from your last return.', 'Check whether you itemize - if not, read the bunching note twice.', 'Give before December 31; the card swipe date is what counts.'], 'faqs': [('How much does a 500 dollar donation save in taxes?', 'At the 22 percent bracket, 110 dollars - but only if you itemize. Since the standard deduction roughly doubled in 2018, about 90 percent of filers take the standard deduction instead, and charitable gifts then save nothing. The calculator says which world you are in.'), ('What is the deadline for tax-deductible donations?', 'December 31 of the tax year. An online card gift counts on the swipe date - December 31 at 11 pm is still this year - and a mailed check counts by postmark. Payroll-deduction gifts count when deducted from pay, even if the charity receives it later.'), ('What receipt do I need for a donation?', 'Under 250 dollars, a bank record or receipt is enough. At 250 dollars or more, the charity must send an acknowledgment letter stating whether they gave you anything in return - the IRS rejects the deduction without it. Get it before filing, not before December 31.'), ('How does donating stock instead of cash help?', 'If you have held appreciated shares over a year, donating them avoids the capital gains tax entirely and still books the full value as a deduction if you itemize. The move works at 500-dollar scale, not just for foundations - brokers handle the transfer in days, so start before mid-December.')]})
    pages.append({'slug': 'free-shipping-threshold-calculator', 'title': 'Free Shipping Threshold Calculator - Is the Filler Item Worth It?', 'h1': 'Free Shipping Threshold Calculator', 'desc': 'Cart total, threshold and shipping fee give a straight verdict on the filler item - plus the minimum to add and both checkout totals compared. Free, no sign-up.', 'category': 'calculator', 'keyword': 'free shipping threshold calculator add to cart for free shipping', 'tool': 'shipfree', 'args': {}, 'intro': ['Enter your cart, the free-shipping threshold and the fee. The calculator tells you the minimum filler that qualifies and compares the honest totals: pay shipping, or add exactly the gap and pay nothing.', 'The trick works because stores set the threshold just above the average cart and count on impulse at the finish line. This one does the math in both directions - and reminds you that paying the fee is not losing; it is declining to buy junk on cue.'], 'howto': ['Cart total first - as it stands, not as you wish.', 'Set the threshold and the shipping fee from the checkout page.', 'If the minimum filler is something you genuinely finish, the filler wins.'], 'faqs': [('Should I add an item to get free shipping?', 'Only when the minimum filler costs less than the shipping fee AND it is something you would buy anyway - batteries, socks, the pantry staple. A nobody-item that costs more than the fee converts free shipping into the most expensive shipping there is.'), ('Why do stores set free shipping thresholds?', 'Just above the average cart value - the gap is designed to trigger an add-on. Raising your cart to cross it is a planned behavior stores profit from; the calculator makes the trade explicit instead of emotional.'), ('Is free shipping really free?', 'No - the cost is spread into the product prices, which is why flat-fee stores can list lower prices. That is also why paying the fee on a small order is honest economics, not a defeat.'), ('What is the minimum I should add to qualify?', 'Exactly the gap between your cart and the threshold - not a dollar more. The calculator shows that figure next to both checkout totals so the decision is one glance, not a debate at the payment screen.')]})
    pages.append({'slug': 'extended-warranty-calculator', 'title': 'Extended Warranty Calculator - Expected Value Before You Say Yes', 'h1': 'Extended Warranty Calculator', 'desc': 'Product price, plan cost and failure odds become an expected-value verdict at the register - with the credit-card double and the self-insurance drawer. Free, no sign-up.', 'category': 'calculator', 'keyword': 'extended warranty worth it calculator expected value', 'tool': 'warranty', 'args': {}, 'intro': ['Enter the product price, the extended warranty cost, what an out-of-pocket repair would run, and honest failure odds for years 2 to 4. The calculator compares the plan against the expected repair cost and gives a plain verdict.', 'Warranty desks exist because the plans are profitable, not generous. The math here shows what odds the plan needs to be worth it - usually far above reality - and covers the two outs people forget: free warranty doubling through many credit cards, and the self-insurance drawer that funds the one failure you actually have.'], 'howto': ['Get the real plan price at the register, not the brochure estimate.', 'Estimate the repair cost honestly - a screen or a logic board, not goodwill.', 'Pick failure odds; most electronics sit near 10 percent in years 2-4.'], 'faqs': [('Are extended warranties worth the money?', 'Usually not on the math: plans are priced with fat margins, so the failure odds needed to justify them run several times reality for most electronics. Exceptions exist - fragile screen-first devices, repair costs close to replacement, or a plan that also covers accident damage you genuinely expect.'), ('Does my credit card cover warranty already?', 'Many cards extend the manufacturer warranty by up to a year for free - the benefit is printed on the card guide. That alone often covers the most likely early-failure window and makes the retail plan redundant before the pitch starts.'), ('What is self-insuring against repairs?', 'Skipping every plan and setting its price aside instead. Across a few gadgets the jar grows faster than the failures arrive, and unspent jar money stays yours - the opposite of a plan, where unused premiums are pure margin.'), ('What failure rate makes a warranty worth it?', 'The warranty cost divided by the repair cost - that is the break-even odds figure in the calculator. If a 120 dollar plan covers a 300 dollar repair, it pays at 40 percent failure odds; real-world rates sit far below, which is the whole business model.')]})
    pages.append({'slug': 'bogo-calculator', 'title': 'BOGO Calculator - What Buy-One-Get-One Deals Really Discount', 'h1': 'BOGO Calculator', 'desc': 'Two prices plus the deal type give what you actually pay, the effective discount, and how it stacks against a plain 30-percent-off sale. Free, no sign-up.', 'category': 'calculator', 'keyword': 'bogo calculator buy one get one deal math', 'tool': 'bogo', 'args': {}, 'intro': ['Enter both item prices and the deal on offer - second at half off, second free, or a flat 30 percent off everything. The calculator shows what you pay, the true effective discount, and the flat-percent sale that would match it.', 'BOGO math quietly assumes the two items cost the same: at equal prices, second-half-off is a clean 25 percent off - but drag a cheaper second item in and the discount slides toward 12. The comparison against a flat sale is the honest benchmark stores hope you skip, right next to the deeper catch: the deal only saves money if the second item was already on your list.'], 'howto': ['Enter the cheaper item first - BOGO rules always discount the pricier second.', 'Pick the deal type from the shelf sign.', 'Compare against the flat-percent figure before you commit to two.'], 'faqs': [('How much of a discount is buy one get one 50% off?', 'At equal prices, exactly 25 percent off the pair - half the second item across two items. With unequal prices it shrinks: a 40 dollar item with a 60 dollar partner discounts the pair by only 20 percent, sliding toward 12 percent as the gap widens.'), ('Is buy one get one free better than 50% off?', 'BOGO free at equal prices equals 50 percent off the pair - better than half-off-second at 25. But it forces quantity: on a single item, plain 50 percent off wins outright because you buy one, not two.'), ('Do BOGO deals save money?', 'Only when the second item was already on your list. The deal engineers a second purchase and calls the bundle a discount - buy two to save is spending 150 percent to feel like you saved. The calculator prices the bundle so the choice is conscious.'), ('Which is better: BOGO or a flat discount?', 'Run both through the calculator: flat 30 percent off wins on unequal prices and on single-item purchases; BOGO free wins only when prices are equal and you genuinely need two. The gap between the deal and the flat sale is printed in the stats.')]})
    pages.append({'slug': 'christmas-tree-water-calculator', 'title': 'Christmas Tree Water Calculator - Quarts Per Day and Refill Schedule', 'h1': 'Christmas Tree Water Calculator', 'desc': 'Trunk diameter and stand size give the daily quarts your tree drinks, the refill interval, and the one dry-day rule that keeps the needles on. Free, no sign-up.', 'category': 'calculator', 'keyword': 'christmas tree water calculator how much water per day', 'tool': 'treewater', 'args': {}, 'intro': ['Measure the trunk diameter at the base, check how many quarts your stand holds, and rate the room warmth. The calculator gives the daily quarts, how often you will refill, and the season total - with the first-day double everyone learns the hard way.', 'Care sheets wander; the rule that holds is one quart per inch of trunk per day. This one prices your room into it - hot rooms drink a third again - and repeats the only rule with real consequences: if the cut goes dry once, sap seals it and the tree never drinks again.'], 'howto': ['Measure trunk diameter across the base, not the branch spread.', 'Find your stand capacity - usually printed on the bottom.', 'Add the fresh cut at planting and never let the basin run dry.'], 'faqs': [('How much water does a Christmas tree need per day?', 'About one quart per inch of trunk diameter daily - a 3-inch trunk drinks 3 quarts, doubled the first day. Warm rooms push it a third higher. The stand should never sit below the cut for even a day.'), ('What happens if my Christmas tree runs dry?', 'The cut end seals with sap within hours and the tree stops absorbing water permanently - no amount of refilling after that helps, and needle drop follows within days. It also turns the tree into a genuine fire hazard, which is why lights-off-when-out matters.'), ('Should I cut the trunk before putting the tree in the stand?', 'Yes - a fresh half-inch cut off the base opens the sap-clogged pores right before the stand. Do it at home the moment the tree arrives, then straight into water; the window matters more than the saw angle.'), ('Do tree additives or sugar help?', 'No - controlled tests keep finding plain water equal or better. The money goes on a stand with a real reservoir instead; the calculator sizes how big it needs to be for your trunk and your refill tolerance.')]})
    pages.append({'slug': 'christmas-tree-lights-calculator', 'title': 'Christmas Tree Lights Calculator - How Many Strings Your Tree Takes', 'h1': 'Christmas Tree Lights Calculator', 'desc': 'Tree height, coverage style and bulb type give the total light count, strings to buy, watts and the season electricity bill. Free, no sign-up.', 'category': 'calculator', 'keyword': 'how many lights for christmas tree calculator strings per foot', 'tool': 'treelights', 'args': {}, 'intro': ['Set the tree height, pick a coverage style - 100 mini lights per foot is the classic, 50 sparse, 150 lush - and choose LED or incandescent. The calculator gives the bulb count, the 100-count strings to buy, the watts when lit, and the season electricity cost.', 'Most light guides stop at the bulb count. This one finishes the job: watts and season dollars from the lights-cost math, the branch-wrap technique that beats circling the tree, and the one power strip that saves the midnight barefoot dash.'], 'howto': ['Height first - measure, do not guess the ceiling clearance.', 'Pick coverage honestly; 100 per foot is already generous.', 'Buy one extra string - dead bulbs are a December tradition.'], 'faqs': [('How many lights for a 6 foot Christmas tree?', 'About 600 mini bulbs for classic coverage - six 100-count strings. Sparse styling takes 300, a lush showcase takes 900. The calculator scales it to your height and style.'), ('How many lights per foot of Christmas tree?', 'The classic rule is 100 mini lights per foot. Thin silhouettes sit at 50; magazine trees push 150-200. Beyond the count, depth matters more - lights woven toward the trunk read twice as bright as surface circles.'), ('Do LED Christmas tree lights save money?', 'Yes - mini LEDs draw about a tenth of the watts of incandescent minis, which over a 45-day season is a few dollars per tree. The bigger saving is longevity: LED strings last many seasons without the mid-December dead-string hunt.'), ('What is the best way to put lights on a tree?', 'Section by section, wrapping each major branch in a triangle from trunk to tip and back, bottom to top. Lights end up deep where they glow instead of skimming the surface, and one droopy section never unwinds the whole spiral.')]})
    pages.append({'slug': 'wrapping-paper-calculator', 'title': 'Wrapping Paper Calculator - Rolls, Square Feet and Cost for Your Gifts', 'h1': 'Wrapping Paper Calculator', 'desc': 'Gift count, size and your honest wrapping style give the square feet of paper, rolls to buy and the cost - with the waste factor priced in. Free, no sign-up.', 'category': 'calculator', 'keyword': 'wrapping paper calculator how many rolls of wrapping paper', 'tool': 'wrapcalc', 'args': {}, 'intro': ['Count the gifts, pick the average size from book to awkward-giant, and rate your folding style - neat folds lose about a fifth of the roll, enthusiastic tape-and-hope loses a third. The calculator gives square feet, rolls and cost.', 'Most roll guides assume perfect cuts and full coverage. This one prices the waste factor honestly - and offers the two real upgrades: kraft butcher paper with a stamp kit at a fraction of character-paper pricing, and gift bags as the buy-once, reuse-for-a-decade endgame.'], 'howto': ['Count every gift on the list, including the office extras.', 'Size the biggest gift first - one giant always hides in the pile.', 'Buy for the biggest, not the average; rounds go to the next full roll.'], 'faqs': [('How much wrapping paper do I need per gift?', 'A book takes about a square foot, a sweater box around 3, a large toy 6 or more - then add the waste factor of your style, 20 to 50 percent. The calculator totals the whole list and rounds up to whole rolls.'), ('How many gifts does one roll of wrapping paper cover?', 'A standard 30-square-foot roll covers roughly 8-10 book-sized gifts or 2-3 sweater boxes once the off-cuts are counted. Awkward shapes eat roll fast, which is why the biggest gift sets the purchase.'), ('Is expensive wrapping paper worth it?', 'Rarely by the square foot - character and foil runs cost up to triple kraft paper for the same coverage. A kraft roll plus a stamp kit or twine reads intentional at a quarter of the price, and leftovers do not look like leftovers.'), ('Are gift bags cheaper than wrapping paper?', 'Per year, no; per decade, yes by a mile. Plain bags survive many seasons of reuse, skip the tape and measuring entirely, and end the folding style debate - the honest endgame for anyone who dreads the paper stage.')]})
    pages.append({'slug': 'road-trip-fuel-calculator', 'title': 'Road Trip Fuel Calculator - Gallons, Cost and Per Person', 'h1': 'Road Trip Fuel Calculator', 'desc': 'Miles, mpg and your gas price give the real fuel bill for the trip, split per passenger - plus the honest note on what fuel-only leaves out. Free, no sign-up.', 'category': 'calculator', 'keyword': 'road trip fuel cost calculator gas money per person', 'tool': 'roadfuel', 'args': {}, 'intro': ['Enter the one-way miles, your highway mpg, the gas price where you fill, and how many people are in the car. The calculator gives gallons burned, the total fuel bill, the per-person split, and the driving hours behind it.', 'Split-the-gas threads argue in circles because nobody states the model. This one states it plainly: fuel-only is the fair number to split, the full cost-per-mile with depreciation is several times higher and belongs to a different conversation, and the per-person figure works only if it is agreed before departure, not negotiated at the pump.'], 'howto': ['Miles one-way from any map app; the round-trip toggle doubles it.', 'Use real highway mpg from your dashboard trip computer, not the sticker.', 'Split per person before leaving - it is a bad conversation at the pump.'], 'faqs': [('How much does a 500 mile road trip cost in gas?', 'At 28 mpg and 3.20 a gallon, about 57 dollars one way - 114 round trip. The calculator prices your car and your pump price exactly, and splits it per passenger.'), ('Should passengers pay full fuel cost?', 'The polite convention is to split the fuel-only figure per person, not the true cost of ownership - wear, tires and depreciation ride with the owner. Agreeing on the number before the trip beats a silent grudge at the first fill-up.'), ('Does holiday traffic burn more gas?', 'Some - crawling and idling can cost 10-20 percent more fuel than free-flow highway, and it costs far more time. Leaving before dawn on peak travel days is the single cheapest upgrade a holiday road trip can buy.'), ('What is the true cost per mile of driving?', 'Fuel is only part of it; with depreciation, tires and maintenance the all-in figure for a typical car runs around 60-70 cents per mile. Use fuel-only for splitting a friendly trip, and the all-in number when deciding whether the trip makes sense at all.')]})
    pages.append({'slug': 'flight-vs-drive-calculator', 'title': 'Flight vs Drive Calculator - All-In Cost Comparison for Any Trip', 'h1': 'Flight vs Drive Calculator', 'desc': 'Fuel against ticket, bags and airport ground costs - the mechanical money verdict plus the honest door-to-door time rule for choosing plane or car. Free, no sign-up.', 'category': 'calculator', 'keyword': 'fly vs drive calculator is it cheaper to fly or drive', 'tool': 'flydrive', 'args': {}, 'intro': ['Enter the trip miles, your car mpg and gas price, the cheapest round-trip airfare, and the bag and airport-ground fees. The calculator names the cheaper way and the gap - with the time rule that actually settles most debates.', 'Airline pages compare ticket to ticket and hide the ground costs; car pages forget that flights exist. This one does the mechanical money math both ways, then applies the honest overhead rule: under 400 miles, door to door, flying almost never wins once the airport buffers are counted - and past 800 the plane usually does.'], 'howto': ['Trip miles door to door, from any map app.', 'Airfare at the cheapest realistic fare, bags and ground rides included.', 'Let the time rule break ties the money cannot.'], 'faqs': [('Is it cheaper to fly or drive?', 'For one person under 400-500 miles, driving usually wins on money and often on time once airport overhead counts. Alone on long trips the flight frequently wins; with a full car, the per-seat math almost always favors driving. The calculator prices your exact numbers.'), ('How much time does airport overhead really add?', 'Count roughly two hours before departure for parking, security and boarding, plus the ride each way - about four hours that never appear on the ticket. Under that overhead, a 400-mile drive is usually faster door to door.'), ('What flight costs do people forget?', 'Checked bags, the seat-selection upsell, airport parking or the ride both ways, and meals at airport prices. Enter them as the bag-and-ground fee and the comparison stops flattering the plane.'), ('When does flying obviously win?', 'Roughly past 800 miles, when the drive crosses two full driving days, or when the trip is one-way. Fuel prices move the crossover less than people expect - time and the number of travelers move it far more.')]})
    pages.append({'slug': 'electric-blanket-cost-calculator', 'title': 'Electric Blanket Cost Calculator - Per Night and Season Electricity', 'h1': 'Electric Blanket Cost Calculator', 'desc': 'Blanket watts, hours and your rate give the per-night cost, the season total, and the ratio against a space heater - warm bed for pocket change. Free, no sign-up.', 'category': 'calculator', 'keyword': 'electric blanket cost calculator running cost per night', 'tool': 'blanket', 'args': {}, 'intro': ['Pick your blanket wattage - a throw runs about 60 W, a king 180 - set the hours and your electricity rate. The calculator gives the per-night cost, the whole winter total, and the ratio against running a 1500 W space heater for the same hours.', 'The verdict is not close: the blanket heats two square metres of bed while the heater fights the whole room, and it shows in the numbers - roughly fifteen times cheaper per hour. The honest pairing is both on timers: heater for the evening, blanket for sleeping, thermostat down where the real savings live.'], 'howto': ['Find the wattage on the blanket label - controllers quote it too.', 'Set realistic hours; most people run 8 with an auto-off.', 'Compare against the space heater figure before touching the thermostat.'], 'faqs': [('How much does it cost to run an electric blanket?', 'A 100 W double blanket for 8 hours costs about 14 cents at typical rates - roughly 16 dollars across a 120-night winter. The king size doubles it and still beats every other form of electric heat per hour of comfort.'), ('Is an electric blanket cheaper than a space heater?', 'By an order of magnitude per hour of personal warmth: the blanket heats the bed, the heater fights the whole room. The smart arrangement uses the heater for evening hours in the living space and the blanket overnight with the thermostat set lower.'), ('Are old electric blankets safe?', 'Replace any blanket over ten years old, or one with kinked wiring, scorch marks or a controller that smells warm. Modern units have auto-off timers and sensors; the fold-dont-crease storage rule is what keeps the internal wiring alive.'), ('Does an electric blanket use a lot of electricity?', 'Very little - it is a 60-180 W device, closer to a laptop charger than a heater. The season total for most users lands under a takeaway dinner, which is why the per-night figure surprises people in the good way.')]})
    pages.append({'slug': 'sourdough-starter-calculator', 'title': 'Sourdough Starter Feeding Calculator - Flour, Water and Discard', 'h1': 'Sourdough Starter Feeding Calculator', 'desc': 'Starter weight and feeding ratio give the exact flour and water to add, the jar total, and the discard it creates - maintenance, build-up and fridge ratios. Free.', 'category': 'calculator', 'keyword': 'sourdough starter feeding ratio calculator flour water', 'tool': 'sourdough', 'args': {}, 'intro': ['Weigh your starter and pick a feeding ratio: 1:1:1 for daily maintenance, 1:2:2 to build up for baking, 1:5:5 for the slow fridge rhythm. The calculator gives the flour and water to add, the jar total, and how much discard the feed implies.', 'Starter guides drown beginners in lore. The grammar is equal parts by weight: feed it its own weight in flour and water and it doubles in four to six hours warm. The calculator also prices the parts nobody explains - the acetone smell is hunger not death, and the discard jar is a feature that pays for the flour.'], 'howto': ['Weigh the starter that stays in the jar - that number drives everything.', 'Pick the ratio for your rhythm: daily, building, or fridge-slack.', 'Mark the jar after feeding; the rise line tells you the truth.'], 'faqs': [('What is the best sourdough starter feeding ratio?', '1:1:1 (starter, flour, water by weight) for a daily room-temperature rhythm, 1:2:2 when building up for a bake, and 1:5:5 for fridge storage - the small-spoon-big-feed trick that buys two or three quiet days.'), ('How much flour and water do I feed my starter?', 'Exactly as much flour as starter, and the same again in water, at 1:1:1 - 100 g of starter takes 100 g of each and lands at 300 g. The calculator scales it to whatever is actually in your jar.'), ('Why does my starter smell like acetone?', 'It is starving, not dying: the acetone note and the liquid on top are hunger signals. Feed it promptly and it forgives completely - the starter that is truly beyond saving is the one with fuzzy mould, not the one that smells like a nail salon.'), ('What do I do with sourdough discard?', 'Keep a jar in the fridge and spend it: pancakes, crackers, waffles and focaccia all take unfed starter happily. The discard is the difference between feeding a hobby and composting money - the calculator shows exactly how much each feed creates.')]})
    pages.append({'slug': 'gym-membership-value-calculator', 'title': 'Gym Membership Value Calculator - Cost Per Visit and Break-Even', 'h1': 'Gym Membership Value Calculator', 'desc': 'Monthly fee over your honest visit count gives the true cost per visit, the break-even against drop-in pricing, and a plain verdict. Free, no sign-up.', 'category': 'calculator', 'keyword': 'gym membership worth it calculator cost per visit', 'tool': 'gymvalue', 'args': {}, 'intro': ['Enter your monthly fee, the visits you actually made - last month, not January - and the drop-in price at a nearby gym. The calculator gives your true cost per visit, the monthly break-even, and a verdict from keep to cancel.', 'Gyms price memberships on no-shows; the business model is selling visits that never happen, which is why January is packed and mid-February is not. This one prices your attendance instead of your aspirations - and points at the pause clause most contracts hide before it points at cancellation.'], 'howto': ['Fee first, then the honest visit count from your check-in history.', 'Find the drop-in rate of any comparable gym nearby.', 'Read the verdict as attendance pricing, not a character judgment.'], 'faqs': [('How many gym visits per month make membership worth it?', 'Divide the fee by the drop-in price: at 45 a month against 15 dollar visits, three visits a month is break-even. Below that, paying per visit wins; above it, the membership earns its keep.'), ('Why do gyms sell so many memberships?', 'Because most members stop coming - the model is built on no-shows, with capacity priced for the February crowd, not the January one. Knowing this reframes the contract: you are paying for the option to attend, and options price lower than usage.'), ('Can I pause my gym membership instead of cancelling?', 'Most contracts have a pause or freeze clause, often 1-3 months for a small fee - it exists because members who pause return, and cancelled ones rarely do. Ask before cancelling; the calculator verdict borderline usually resolves with a pause.'), ('What is a fair price per gym visit?', 'Drop-in rates run 10-25 dollars in most cities. If your membership cost per visit sits under that, you are winning; if it sits over double, the treadmill has been quietly winning for months.')]})
    pages.append({'slug': 'dry-january-savings-calculator', 'title': 'Dry January Savings Calculator - What the Break Actually Saves', 'h1': 'Dry January Savings Calculator', 'desc': 'Your honest weekly drink count times venue price gives the month, quarter or full-year savings - with the visibility trick that makes it stick. Free, no sign-up.', 'category': 'calculator', 'keyword': 'dry january savings calculator how much money save not drinking', 'tool': 'dryjan', 'args': {}, 'intro': ['Enter the drinks you actually have in a week, what they typically cost, and how long the break runs - one month, a quarter, or a year. The calculator totals the savings and projects what a year of the same habit change is worth.', 'The math here counts money only; sleep, liver markers and mood are real but unpriced. What the calculator adds is the psychological trick behind every successful savings habit: put the not-spent money somewhere visible weekly, because an invisible non-purchase is a number nobody celebrates.'], 'howto': ['Count an honest average week - holidays and all.', 'Price it at your real venue, not the bottle shop.', 'Give the savings a landing place - a jar beats a vague intention.'], 'faqs': [('How much money does Dry January save?', 'Six drinks a week at bar prices is about 42 dollars a week - 168 over the month, over 2,000 if the habit change holds a year. Home pours save a third of that; the calculator prices your real venue mix.'), ('Why are bar drinks so expensive?', 'Markup on alcohol at bars and restaurants runs three to five times retail - you are paying for the seat, the glassware and the evening. The calculator assumes your honest average, which is where most people underestimate.'), ('Does the savings math include health benefits?', 'No - this counts cash only. Better sleep and the rest are real but vary person to person; the money is the part that lands weekly and the part a jar makes visible.'), ('What is the best way to actually keep the savings?', 'Give them a landing place at the moment of decision: transfer the not-spent amount weekly to a labeled account or a jar. The number that grows in public is the reason Dry January accounts stay open past week two.')]})
    pages.append({'slug': 'books-per-year-calculator', 'title': 'Books Per Year Calculator - What Your Daily Pages Add Up To', 'h1': 'Books Per Year Calculator', 'desc': 'Daily pages, average book length and reading speed give your books-per-year total, days per book, and the minutes-a-day reality check. Free, no sign-up.', 'category': 'calculator', 'keyword': 'books per year calculator how many books reading 20 pages a day', 'tool': 'booksyear', 'args': {}, 'intro': ['Enter the pages you read on an average day, the length of your typical book, and your pace. The calculator gives books per year, how long one book takes, and the minutes-a-day figure that is the whole habit in miniature.', 'Twenty pages a day sounds small and lands around thirty books a year - the entire gap between wishing you read more and a reading life is a page count, not a resolution. The calculator also holds the two honest notes: audiobook minutes count at standard narration pace, and the book-length field is where self-deception lives.'], 'howto': ['Set a pages number you can hit on your worst day, not your best.', 'Use the average length of the books actually on your shelf.', '225 wpm is also audiobook narration pace - commutes count.'], 'faqs': [('How many books can I read in a year?', 'Twenty pages a day compounds to about 24 books of average length - 30 if your books run 250 pages. Ten pages a day still lands around 12, which is more than most people finish. The calculator prices your exact habit.'), ('How long does it take to read 300 pages?', 'At 20 pages a day, fifteen days; at 40, a week. In hours: roughly 6-7 at average pace. The days-per-book figure is the one that turns a shelf into a schedule.'), ('Do audiobooks count as reading?', 'For the math, yes - 225 wpm is also standard audiobook narration pace, so the minutes convert one to one. The habit argument is yours to have; the calculator counts the time honestly either way.'), ('How do I read more books without rushing?', 'Set a pages number sized for your worst day, keep the book visible, and stop counting minutes of scrolling as reading-adjacent. The compounding does the rest - that is literally what this calculator shows.')]})
    pages.append({'slug': 'dehumidifier-size-calculator', 'title': 'Dehumidifier Size Calculator - Pints Per Day for Your Room', 'h1': 'Dehumidifier Size Calculator', 'desc': 'Room area and dampness level give the pints-per-day rating to shop for, the running watts and the monthly cost - with the 40-50 percent target. Free, no sign-up.', 'category': 'calculator', 'keyword': 'dehumidifier size calculator what size dehumidifier for room', 'tool': 'dehumid', 'args': {}, 'intro': ['Enter the room area and how damp it honestly is - musty smell, window condensation, or mold spots. The calculator gives the pints-per-day rating to buy, the running watts, and what ten hours a night costs on your bill.', 'The rating on the box assumes a specific lab room, and basements cheat. This one scales by area and dampness, points at the 40-50 percent humidity target where mold stops and sinuses survive, and explains the window-condensation signal that winter sends every morning.'], 'howto': ['Measure the room, not the floor plan - the machine dehumidifies one space.', 'Rate the dampness honestly; mold spots mean the top bracket.', 'Basements and bathrooms take one size up from the number.'], 'faqs': [('What size dehumidifier do I need for my room?', 'Industry ratings run about 8 pints per day for slightly damp 500 square feet, up to 16 for very damp. The calculator scales to your area and dampness - and basements deserve the next size up.'), ('What humidity should I set my dehumidifier to?', '40 to 50 percent relative humidity. Above 50 the mold and dust mites feed; below 40, wood cracks and throats complain. A unit with a humidistat stops at the target instead of running forever.'), ('Why is my bedroom window wet in the morning?', 'Warm indoor air holds moisture that condenses on the cold glass overnight - breathing, drying clothes and cooking all feed it. Ventilation helps at the source; a dehumidifier closes the gap in the dampest room.'), ('Do dehumidifiers use a lot of electricity?', 'A typical room unit draws 200-400 watts - about the same as the fridge it sits next to. Run ten hours a night and the calculator prices it; the humidistat keeps the real bill lower by coasting at the target.')]})
    pages.append({'slug': 'secret-santa-calculator', 'title': 'Secret Santa Calculator - Gift Pool, Budget Cap and Group Savings', 'h1': 'Secret Santa Calculator', 'desc': 'Participants and budget cap give the number of gifts, the whole-group spend, and what everyone saves versus buying for all - plus the three draw rules. Free.', 'category': 'calculator', 'keyword': 'secret santa calculator gift exchange budget per person', 'tool': 'santamath', 'args': {}, 'intro': ['Enter how many people are in the draw and the budget cap. The calculator shows the gifts in play, the whole-group spend, and what each person saves against buying something for everyone.', 'The draw has three rules that matter - nobody draws themselves, couples can be excluded as pairs, and the cap is a contract. This page prices the savings for the family skeptic, and makes the case that paper names in a hat beat every app for the aunts.'], 'howto': ['Count the participants, including the ones who claim they want nothing.', 'Set a cap everyone can afford - the cap is the whole game.', 'Wishlists are the luxury move: one link per person beats guessing.'], 'faqs': [('How does a Secret Santa draw work?', 'Everyone draws one name and buys only for that person, within the agreed cap - so everyone gives once and receives once. The calculator shows the group math: eight people at a 25 dollar cap exchange eight gifts instead of fifty-six.'), ('What is a good Secret Santa budget?', 'Whatever the poorest member can do without thinking - typically 15-30 dollars. The cap is a contract, not a suggestion: the person who overspends breaks the game for whoever cannot match it.'), ('How do I make sure nobody draws themselves?', 'Paper names in a hat, redraw on self-draw, works fine to about twenty people - and beats every app for family groups. For bigger crowds or remote relatives, free online draw tools handle exclusions automatically.'), ('Can couples be excluded from drawing each other?', 'Yes - exclude pairs as a block and redraw; the math barely changes and the household harmony doubles. Most families run exactly this rule and consider it obvious.')]})
    pages.append({'slug': 'champagne-calculator', 'title': 'Champagne Calculator - Bottles Needed for Your Party', 'h1': 'Champagne Calculator', 'desc': 'Guests and glasses per head give the bottles to chill, the total cost, and the mimosa juice ratio - six honest pours per bottle. Free, no sign-up.', 'category': 'calculator', 'keyword': 'how many bottles of champagne for 10 guests calculator party', 'tool': 'champagne', 'args': {}, 'intro': ['Enter the guest count, how many glasses each will actually have through the evening, and your bottle price. The calculator gives bottles to chill, the total cost, and the juice ratio if brunch turns it into mimosas.', 'The math most hosts get wrong is generosity before ten: a 750 ml bottle pours six honest 125 ml glasses, and running dry at the toast is a bigger social cost than one leftover bottle. The label talk is honest too - blind tastings keep finding mid-shelf cava beats famous champagne at three times the price.'], 'howto': ['Count guests, then choose toast-only versus a proper evening.', 'Six glasses per bottle is the honest pour, not the optimistic one.', 'Chill for at least three hours; warm bubbles foam over half the glass.'], 'faqs': [('How many bottles of champagne for 10 guests?', 'For a proper evening of three glasses each, that is 30 glasses - five bottles at six pours per 750 ml. A toast-only night needs two. The calculator scales to your crowd and your pour honestly.'), ('How many glasses are in a bottle of champagne?', 'Six 125 ml pours from a 750 ml bottle - seven if you pour conservatively. Party math that assumes eight is why so many toasts run out before midnight.'), ('Is expensive champagne worth it for a party?', 'For toasts and mimosas, no - blind tastings repeatedly rank mid-shelf cava and cremant above big-name bottles at triple the price. Spend on the bottle you hand someone who loves wine; pour the honest stuff for the crowd.'), ('How much orange juice for mimosas?', 'The classic mix is two parts juice to one part bubbles, so each bottle of bubbles wants about a liter of juice - the calculator totals it for your glass count. Fresh-squeezed is the only upgrade anyone actually notices.')]})
    pages.append({'slug': 'gift-return-deadline-calculator', 'title': 'Gift Return Deadline Calculator - Last Day to Return Anything', 'h1': 'Gift Return Deadline Calculator', 'desc': 'Purchase date plus the store window gives the exact last return day, days remaining, and the holiday-extension fine print - with a calendar download. Free, no sign-up.', 'category': 'calculator', 'keyword': 'gift return deadline calculator how many days to return', 'tool': 'giftreturn', 'args': {}, 'intro': ['Enter the purchase date and the store return window. The calculator gives the exact last day, how much time is left, and a calendar download so the deadline stops living in your head.', 'The annual trap is built in: return clocks run on the purchase date, not the gift date, so November presents expire by Boxing Day - which is exactly why stores extend holiday purchases to late January. This calculator catches the trap and explains the no-receipt reality: store credit at the current price, not a refund.'], 'howto': ['Set the real purchase date - check the receipt, not your memory.', 'Pick the window printed on the receipt or policy page.', 'Download the reminder; the week after the holiday has the shortest queue.'], 'faqs': [('How many days do I have to return a gift?', 'Most stores run 30 days from purchase; some run 14 for electronics and 60-90 for generous retailers. Gifts bought in November on a 30-day window are technically expired by late December - always check for the holiday extension.'), ('Can I return a gift without a receipt?', 'Usually yes, but as store credit at the current selling price - not a refund to the buyer. The gift receipt exists precisely for this: it proves the purchase without revealing the price.'), ('Do stores extend return windows for Christmas?', 'Many do - purchases from November onward often run to January 31. It is printed on the receipt or the policy page, and it is the single most useful line to read before standing in the post-Christmas queue.'), ('What cannot be returned after opening?', 'Electronics activated with accounts, sealed health and personal items, custom or personalized goods, and anything digital. Keep packaging intact on anything with return potential - opened-box restocking fees start at 15 percent.')]})
    pages.append({'slug': 'ice-melt-calculator', 'title': 'Ice Melt Calculator - Bags of Salt for Your Driveway This Winter', 'h1': 'Ice Melt Calculator', 'desc': 'Driveway area, product type and storm count give pounds per application, bags for the winter and the cost - with the pet-paw and concrete warnings. Free, no sign-up.', 'category': 'calculator', 'keyword': 'ice melt calculator how much salt per driveway bags', 'tool': 'icemelt', 'args': {}, 'intro': ['Enter your driveway and walkway area, the product you use, how many storms you realistically fight each winter, and the bag price. The calculator gives pounds per application, bags for the season, and the cost.', 'More salt does not melt faster - the right dose works once and the surplus wrecks concrete and paws. This calculator prices the product honestly by type: rock salt quits near 5 F, blends reach -10, calcium chloride keeps working to -25, and the pet-safe blends cost more for reasons the paws will explain.'], 'howto': ['Measure the paved area you actually clear, including the walkway.', 'Pick the product for your coldest realistic storm, not the record.', 'Buy at season start; the first storm empties the aisle.'], 'faqs': [('How much ice melt do I need per 1000 square feet?', 'About 4 pounds of rock salt, 6 of a blended melt, or 3 of calcium chloride per application. Spreading double does not double the speed - it doubles the runoff, the concrete damage and the cost.'), ('Which ice melt is safe for pets and concrete?', 'Pet-safe blends use gentler salts and cost more per bag; on paws, any product should be wiped off after walks. On concrete under one year old, avoid rock salt entirely - use calcium-based products sparingly, or sand for traction.'), ('At what temperature does rock salt stop working?', "Around 5 F (-15 C). Blends reach roughly -10 F and calcium chloride keeps melting near -25 F. Below a product limit, adding more does nothing - that is what the calculator's temperature column is for."), ('Should I salt before or after snow?', 'Before, if you can - a pre-treat layer stops the bond forming and turns the shovel job into a sweep. After, it still works but slower. The calculator sizes the per-storm dose either way.')]})
    pages.append({'slug': 'home-gym-payback-calculator', 'title': 'Home Gym Payback Calculator - Months to Beat the Membership', 'h1': 'Home Gym Payback Calculator', 'desc': 'Equipment cost over your gym fee gives the payback months, the quit-case net with resale, and the 300-dollar starter kit reality. Free, no sign-up.', 'category': 'calculator', 'keyword': 'home gym worth it calculator payback vs gym membership', 'tool': 'homegym', 'args': {}, 'intro': ['Enter the equipment cost and the monthly fee it replaces. The calculator gives the payback in months, what the gym would have cost in that time, and - the honest part - your net if you quit after a year, resale value included.', 'The payback math is simple division; the quit case is where calculators usually stop. This one prices resale, names the 300-dollar starter kit that covers most routines, and admits what the membership includes: showers, a change of scene, and nobody re-racking your weights.'], 'howto': ['Price the gear you would actually buy, not the showroom dream.', 'Set the fee honestly - the one you would really cancel.', 'Read the quit-case line before, not after, the credit card swipe.'], 'faqs': [('Is a home gym cheaper than a gym membership?', 'Past the payback months - equipment cost divided by the fee - yes, and the gap widens every month after. At 45 a month, 600 dollars of gear pays back in 14 months; everything beyond is profit measured in not-going.'), ('What home gym equipment is worth buying first?', 'Adjustable dumbbells and an adjustable bench, about 300 dollars together - they cover most strength routines, store in a corner and resell near half price. The expensive machines are the ones that become clothes racks.'), ('What is the real cost of quitting a home gym?', 'The resale haircut: gear resells around 30-70 percent depending on care and market. The calculator nets that against the membership fees you skipped, which is why quitting in month two is expensive and quitting in year three is a refund.'), ('Does a home gym replace everything a commercial gym offers?', 'No - showers, machines for isolation work, and the change of scene are real value for some people. The honest comparison is the workout you actually do, in the place you actually do it, at the price that keeps you doing it.')]})
    pages.append({'slug': 'slow-cooker-converter', 'title': 'Slow Cooker Converter - Oven Time to Low and High Settings', 'h1': 'Slow Cooker Converter', 'desc': 'Convert any oven recipe time to slow cooker hours on low or high - with the liquid, dairy and lid-lid rules that carry the dish. Free, no sign-up.', 'category': 'calculator', 'keyword': 'slow cooker conversion oven to crockpot time calculator', 'tool': 'slowcook', 'args': {}, 'intro': ['Enter the oven time from the recipe and pick a setting. The converter uses the standard published conversion bands - a one-hour oven dish becomes roughly five hours on low - and shows the other setting too, because plans change at noon.', 'Most conversion charts stop at the hours. This one adds the three rules that actually carry the dish: cut liquids in half because nothing evaporates under the lid, add dairy and seafood in the last hour, and never lift the lid - each peek costs about twenty minutes of cooking.'], 'howto': ['Read the oven time and temperature off the original recipe.', 'Pick low for all-day cooking or high for the afternoon start.', 'Halve the liquids and hold the dairy until the end.'], 'faqs': [('How do I convert oven time to slow cooker time?', 'Use the standard bands: 15-30 oven minutes becomes 4-6 hours on low; 35-45 minutes becomes 6-8 on low; anything from 50 minutes to 3 hours becomes 8-10 on low. High runs about half of low. The calculator quotes the midpoints.'), ('Does slow cooker liquid need reducing?', 'Cut it by about half - the sealed lid means nothing evaporates, and recipes written for ovens assume reduction. You can always thicken at the end with the lid off; you cannot un-soup a stew.'), ('Can I put milk or cream in a slow cooker?', 'Not at the start - dairy curdles over long hours. Stir milk, cream, yogurt or sour cream in during the last thirty to sixty minutes; the same rule sends seafood and fresh herbs late.'), ('Does lifting the lid really matter?', 'Yes - each peek releases heat and costs roughly twenty minutes of cooking time. The slow cooker is designed to be closed; check through the glass if you must, and trust the machine on anything except the last hour.')]})
    pages.append({'slug': 'pto-optimizer', 'title': 'PTO Optimizer - Turn Vacation Days into Maximum Days Off', 'h1': 'PTO Optimizer', 'desc': 'Split your PTO across chained breaks so weekends ride free - see calendar days off versus one naive block, plus the Wednesday trick. Free, no sign-up.', 'category': 'calculator', 'keyword': 'pto optimizer how to maximize vacation days 2027', 'tool': 'ptoopt', 'args': {}, 'intro': ['Enter your annual PTO and how many breaks you want. The optimizer splits it into Monday-to-Friday chains so the weekends on both ends ride free, and shows the calendar days you get versus one naive block.', 'The chain rule: a PTO day only buys a workday unless it touches a weekend. Fifteen days split into three five-day breaks is twenty-one calendar days off - and the extreme version, the Wednesday trick, turns a single day into nine days of coverage. Book the July flights in January; the cheapest seats of the year sell while everyone else is writing resolutions.'], 'howto': ['Set your total PTO - the number on your offer letter, not your hopes.', 'Choose the break count; three five-day chains fit most years.', 'Anchor each chain to a public holiday for a free extra day.'], 'faqs': [('How do I maximize my PTO days?', 'Never spend PTO on a weekend side - chain every break from Monday to Friday so four weekend days ride free per break. Split 15 days into three chains and you get 21 calendar days instead of 17 in one block.'), ('What is the Wednesday trick?', 'Take only the Wednesday that sits between two weekends: one PTO day buys nine consecutive days away from the desk. It works because the weekends bracket the single day - the cheapest coverage in the PTO playbook.'), ('When should I book flights for next year?', 'January, for the summer. Airlines price leisure routes low while demand is seasonal-low and everyone is budgeting rather than booking - the same seats cost noticeably more from spring onward.'), ('Should I take one long vacation or several breaks?', 'Research on recovery favors multiple breaks: the refresh from a week away fades within weeks, so three resets beat one long block for year-round wellbeing. The optimizer shows what the chaining costs - usually nothing but planning.')]})
    pages.append({'slug': 'credit-card-minimum-payment-calculator', 'title': 'Credit Card Minimum Payment Calculator - Years and Interest Revealed', 'h1': 'Credit Card Minimum Payment Calculator', 'desc': 'Balance and APR versus the minimum-payment math: years to repay, total interest, and what a fixed payment saves - the trap made visible. Free, no sign-up.', 'category': 'calculator', 'keyword': 'credit card minimum payment calculator how long to pay off', 'tool': 'minpay', 'args': {}, 'intro': ['Enter your balance, the APR from your statement, and what you could pay monthly instead. The calculator amortizes both paths: years and interest at minimum-only, versus months and interest at your fixed payment.', 'The minimum is engineered, not helpful - at a 22 percent APR, interest eats most of a 2 percent minimum, so the balance barely moves for years. That is the business model working as designed, and the comparison line is the same card paid like a normal loan.'], 'howto': ['Balance and APR straight off the statement.', 'Set the fixed payment you can genuinely sustain monthly.', 'Compare the interest columns - then point the extra at the highest-APR card.'], 'faqs': [('How long does it take to pay off a credit card with minimum payments?', 'At 2 percent minimums and a 22 percent APR, a 3,000 dollar balance runs for over a decade and costs thousands in interest - the early payments barely cover the monthly charge. The calculator runs your exact numbers.'), ('Why is my minimum payment so low?', 'Because a low minimum maximizes interest: the floor is engineered around the card profit model, not your payoff. Regulators now force issuers to print the warning on statements - the calculator makes it concrete.'), ('What happens if I pay more than the minimum?', 'Everything above the minimum hits principal directly, which compounds in your favor: the fixed-payment column shows months and interest collapsing at the same time. Even 20 extra dollars a month changes the curve visibly.'), ('Is a balance transfer worth it?', 'Often, yes: a 0 percent transfer with a 3 percent fee beats a year of 22 percent interest if you actually clear the balance inside the window. The fee is the whole cost - the trap is treating the new card as fresh spending room.')]})
    pages.append({'slug': 'meal-prep-batch-calculator', 'title': 'Meal Prep Batch Calculator - Cost Per Meal vs Takeout', 'h1': 'Meal Prep Batch Calculator', 'desc': 'Batch portions and ingredient cost versus your real takeout price - savings per week, batches to cook, and the year figure. Free, no sign-up.', 'category': 'calculator', 'keyword': 'meal prep cost calculator batch cooking vs takeout', 'tool': 'mealprep', 'args': {}, 'intro': ['Enter meals to cover, portions per batch, what a batch of ingredients costs, and your real takeout price. The calculator gives cost per meal, weekly savings, batches to cook, and the year figure.', 'The takeout number is the honest one - fee, tip and tax add roughly a third on top of the menu price. The honest counterweight is batch fatigue: freeze half the batch and run two recipes a week, because five identical dinners by Wednesday is how the habit dies.'], 'howto': ['Count the weekday meals you actually buy, not ideal ones.', 'Price a batch from your last grocery receipt, not an aspirational one.', 'Freeze half of every batch - variety is what makes prep stick.'], 'faqs': [('How much does meal prep save per week?', 'At 3 dollars per batch meal against 14 dollar takeout, five weekday meals save about 55 dollars a week - over 2,600 a year on 48 working weeks. The calculator prices your real portions and your real takeout habit.'), ('Is meal prep actually cheaper than cooking daily?', 'Marginally cheaper on ingredients - the real win is time and the takeout it replaces. Bulk ingredients, one cook session and zero delivery fees beat both daily cooking and daily ordering.'), ('How do I avoid getting bored of meal prep?', 'Two recipes per week with the freezer as the variety engine: cook one batch, freeze half, pull a different cuisine next week. The fatigue is real and the rotation is the standard fix.'), ('What do delivery fees really add?', 'App fee, service fee, tip and tax typically add 30 percent or more over the menu price - the number on the checkout screen, not the menu, is the honest takeout figure for this comparison.')]})
    pages.append({'slug': 'heating-oil-tank-calculator', 'title': 'Heating Oil Tank Calculator - Days Left, Refill Cost and Order Timing', 'h1': 'Heating Oil Tank Calculator', 'desc': 'Tank size, gauge reading and burn rate give usable gallons, days of heat left and the refill cost - with the order-at-one-third rule. Free, no sign-up.', 'category': 'calculator', 'keyword': 'heating oil tank gauge calculator how many days oil left', 'tool': 'oiltank', 'args': {}, 'intro': ['Pick your tank size, read the gauge, set your cold-week burn rate and the local price per gallon. The calculator gives usable gallons, days of heat left, the refill-to-full cost, and the gauge where you should order.', 'Two gauge truths carry this page: the tank never holds its rated number - a 275 gallon basement tank delivers about 240 usable gallons - and the float gauge is a hint, not an instrument. Order at one third, because winter queues, emergency surcharges and a bleed-the-line restart are all more expensive than planning.'], 'howto': ['Tank size from the label; 275 is the standard basement unit.', 'Read the gauge and be honest about your cold-week burn rate.', 'Order at a third of a tank - the calculator shows why.'], 'faqs': [('How long will 100 gallons of heating oil last?', 'At a typical winter burn of 5 gallons a day, about 20 days. The real rate varies with house size and cold snaps - tracking one cold week gives you a personal number better than any rule of thumb.'), ('Why does my 275 gallon tank only take 240 gallons?', 'The pickup line and the internal geometry reserve the bottom of the tank - roughly 90 percent of rated capacity is usable. The calculator applies the same factor to any size.'), ('When should I order heating oil?', 'At about one third of a tank. Winter delivery queues stretch to days, emergency or will-call fills carry surcharges, and running dry means a technician visit to bleed the line before the burner restarts.'), ('Is heating oil cheaper in summer?', 'Usually - summer and early-fall prices run lower and deliveries are slower-paced, so filling before the first cold snap beats panic-buying in January. The calculator prices the refill so you can time it.')]})
    pages.append({'slug': 'home-office-deduction-calculator', 'title': 'Home Office Deduction Calculator - Simplified vs Actual Method', 'h1': 'Home Office Deduction Calculator', 'desc': 'Square feet times 5 dollars under the simplified method, compared against your actual expense share - with the exclusive-use gate that decides everything. Free, no sign-up.', 'category': 'calculator', 'keyword': 'home office deduction calculator simplified method square feet', 'tool': 'homeded', 'args': {}, 'intro': ['Enter the office square footage and your monthly housing cost. The calculator runs the simplified method - 5 dollars per square foot, capped at 300 - and estimates what the actual-expense method would claim from your rent share, naming the better route.', 'Two gates decide this deduction before any math: the space must be regular AND exclusive work use - a desk in the living room fails - and since 2018, W-2 employees working from home cannot claim it at all. This is a self-employed and freelance deduction, and the calculator says so up front instead of after the audit letter.'], 'howto': ['Measure the dedicated workspace - the part that is truly office.', 'Enter monthly rent or housing cost for the actual-method estimate.', 'Compare both methods; keep receipts only if actual wins.'], 'faqs': [('How does the simplified home office deduction work?', 'Five dollars per square foot of dedicated office space, capped at 300 square feet - up to 1,500 dollars, no receipts required. The calculator runs it against your actual expense share so the choice is a number, not a guess.'), ('Can I claim a home office as a W-2 employee?', 'No - the 2017 tax reform suspended unreimbursed employee expenses. The deduction lives on for the self-employed, freelancers and side businesses; employees get nothing even with a perfect home office.'), ('What does exclusive use actually mean?', 'The space works only as an office: a spare room with a desk passes, the kitchen table you clear at dinner fails, and a guest room with a treadmill corner fails the strict version. It is the gate audits test first.'), ('Is the simplified or actual method better?', 'Simplified wins for small spaces and modest rents; actual wins when the office share of real rent, utilities and insurance exceeds 5 dollars a foot - which happens fast above 200 square feet in high-rent cities. The calculator prices both.')]})
    pages.append({'slug': 'self-employment-tax-set-aside-calculator', 'title': 'Self-Employment Tax Calculator - Your 1099 Set-Aside Percentage', 'h1': 'Self-Employment Tax Set-Aside Calculator', 'desc': 'Expected 1099 income plus your bracket gives the set-aside percentage, the SE tax, quarterly payments and the safe-harbor rule that ends penalty fear. Free.', 'category': 'calculator', 'keyword': 'self employment tax calculator set aside percentage 1099', 'tool': 'setaside', 'args': {}, 'intro': ['Enter your expected 1099 income and tax bracket. The calculator stacks self-employment tax - 15.3 percent on 92.35 percent of net profit - with income tax, and hands back the percentage of every payment to set aside.', 'New freelancers discover the SE tax the expensive way: self-employed income pays both halves of Social Security and Medicare. This calculator prices the full stack into a per-payment percentage, lists the quarterly dates, and explains the safe-harbor rule that makes underpayment penalties structurally impossible.'], 'howto': ['Estimate the year 1099 income from contracts or last year.', 'Pick your marginal bracket for the income-tax layer.', 'Move the shown slice to a separate account per client payment.'], 'faqs': [('How much should I set aside for self-employment taxes?', 'Plan on 25-35 percent of net income: the 15.3 percent SE tax plus your income bracket. The calculator prices your exact stack - the separate-account habit is what makes the number stick.'), ('What is the self-employment tax rate?', '15.3 percent - both halves of Social Security and Medicare - applied to 92.35 percent of net profit. The discount acknowledges that employees split the bill with an employer, and the self-employed pay both halves.'), ('When are quarterly estimated taxes due?', 'April 15, June 15, September 15 and January 15 of the following year - the quarters do not match calendar quarters, and June is the one that sneaks up on everyone.'), ('What is the safe harbor rule for estimated taxes?', 'Pay 100 percent of last year total tax across the quarters - 110 percent for higher incomes - and no underpayment penalty applies no matter what you owe this year. It converts a volatile income into a predictable payment plan.')]})
    pages.append({'slug': 'charitable-miles-calculator', 'title': 'Charitable Miles Calculator - Volunteer Driving Deduction at 14 Cents', 'h1': 'Charitable Miles Calculator', 'desc': 'Volunteer miles at the statutory 14 cents plus parking and tolls - with the 501(c)(3) rule, the commute exclusion and the log that survives audit. Free, no sign-up.', 'category': 'calculator', 'keyword': 'charitable mileage rate calculator volunteer miles deduction', 'tool': 'charmile', 'args': {}, 'intro': ['Enter the miles you drove for charity and any parking or tolls. The calculator applies the statutory volunteer rate - 14 cents a mile, a figure the IRS has frozen for years - and adds your out-of-pocket costs.', 'The honest framing: this deduction is modest, rides on itemizing like all charitable giving, and only counts for qualified 501(c)(3) organizations. Your commute to a regular volunteer shift does not count; the dated log written the same week is what survives an audit.'], 'howto': ['Tally the year volunteer driving from your calendar or log.', 'Add parking and tolls paid while volunteering.', 'Keep the log current - reconstructed mileage is the audit classic.'], 'faqs': [('What is the IRS mileage rate for charity work?', '14 cents per mile - fixed by statute for years while business rates float upward annually. It is deliberately modest; the deduction also requires itemizing, like the rest of charitable giving.'), ('Does driving to volunteer count?', 'Miles driven in service of the charity count - delivering meals, hauling supplies. Your ordinary commute to a regular volunteer location does not, and neither does any route with a personal detour priced in.'), ('What records do I need for charitable miles?', 'A dated written log: date, destination, purpose, miles. Reconstructed logs are the classic audit failure; a note on your phone the same week converts to a defensible record at tax time.'), ('Can I deduct volunteer out-of-pocket costs?', 'Yes - parking, tolls and unbought supplies for the charity add on top of mileage. Uniform costs count too; the value of your time famously never does.')]})
    pages.append({'slug': 'date-night-cost-calculator', 'title': 'Date Night Cost Calculator - Dinner, Activity and the Sitter Truth', 'h1': 'Date Night Cost Calculator', 'desc': 'Dinner, activity and sitter hours give the real per-date cost, the monthly figure and the year - with the swap-circle fix that halves it. Free, no sign-up.', 'category': 'calculator', 'keyword': 'date night cost calculator with babysitter dinner movie', 'tool': 'datenight', 'args': {}, 'intro': ['Enter dinner, the activity, and the sitter rate and hours. The calculator gives the true per-date cost, the monthly figure at twice a month, and the share the sitter quietly takes.', 'For parents the childcare line dwarfs dinner - which is why the swap circle with trusted friends (you take their Tuesday, they take yours) is the single biggest cost fix in this budget. The research note justifies the spend: novelty beats grandeur, so frequent small new experiences outperform the annual famous reservation.'], 'howto': ['Price dinner and the activity honestly - taxes and tip included.', 'Set sitter rate and hours; round trips count.', 'Read the monthly figure - that is the budget line that matters.'], 'faqs': [('What is a reasonable date night budget?', 'Dinner for two runs 60-120 depending on the city, activities 0-60, and a sitter 60-90 for the evening - so 120-250 total with childcare. The calculator prices your actual pattern, including the monthly figure that belongs in the budget.'), ('How can we make date nights cheaper?', 'The sitter swap with another family you trust - alternate Tuesdays, zero cash - halves the total instantly. Lunch dates, museum free days and the walking-and-talking format carry most of the benefit at a fraction of the cost.'), ('Is an expensive date night worth it?', 'The research on relationships points at frequency and novelty, not grandeur: new shared experiences - a new cuisine, a class, an unfamiliar neighborhood - outperform repeated luxury. Budget for frequency first; let the grand nights be a bonus.'), ('How often should couples have a date night?', 'Weekly is the classic advice; twice a month is where the measurable relationship benefits show up in studies. The calculator prices either cadence so the choice is a budget line, not a guilt spiral.')]})
    pages.append({'slug': 'seed-starting-calculator', 'title': 'Seed Starting Calculator - When to Sow Indoors Before Last Frost', 'h1': 'Seed Starting Calculator', 'desc': 'Last frost date plus your crop gives the indoor sowing date, the transplant week, and days from today - tomatoes to lettuce on the consensus table. Free.', 'category': 'calculator', 'keyword': 'seed starting calculator when to start seeds indoors last frost', 'tool': 'seedstart', 'args': {}, 'intro': ['Enter your last frost date and pick the crop. The calculator counts back the consensus weeks - peppers nine, tomatoes seven, cucumbers three - and gives the indoor sowing date, the transplant week, and days from today.', 'The seed packet is the boss; this table is the consensus window your variety and zone nudge. The two rules that separate thriving starts from leggy disappointment: light beats warmth once sprouted - a shop light an inch above the tray beats any windowsill - and transplant week is earned outdoors gradually, or the sun burns a month of care in one afternoon.'], 'howto': ['Enter your area last frost date - extension tables have it for your town.', 'Pick each crop; the weeks-before-frost are built in.', 'Set a shop light an inch above the seedlings; windows stretch them.'], 'faqs': [('When should I start tomato seeds indoors?', 'Six to eight weeks before your last frost - seven is the sweet spot. Earlier is not better: tomatoes outgrow their trays and get leggy before the garden is ready, and leggy starts fruit less.'), ('What happens if I start seeds too early?', 'Root-bound, light-starved transplants that wait weeks for the soil to warm - the head start evaporates. Peppers and tomatoes hold at a smaller size better than they recover from stretched stems.'), ('Do I need grow lights to start seeds?', 'For anything beyond lettuce, effectively yes: a cheap shop light an inch above the seedlings for 14-16 hours beats the brightest windowsill, because winter sun is weak and low-angle - the legginess people blame on variety is usually window light.'), ('What is hardening off?', 'The transplant-week discipline: an hour of outdoor shade the first day, doubling daily, until the starts survive full sun and breeze. Skipping it burns a month of indoor care in a single afternoon - the calculator schedules the week so it is not skipped.')]})
    pages.append({'slug': 'raised-bed-soil-calculator', 'title': 'Raised Bed Soil Calculator - Cubic Feet, Bags and Cost', 'h1': 'Raised Bed Soil Calculator', 'desc': 'Bed dimensions times depth give cubic feet of soil, the 1.5 cu ft bag count, the cost, and the two-inch top-up figure for established beds. Free, no sign-up.', 'category': 'calculator', 'keyword': 'raised bed soil calculator how much soil cubic feet bags', 'tool': 'bedsoil', 'args': {}, 'intro': ['Enter the bed length, width and soil depth. The calculator gives cubic feet, the number of 1.5 cubic foot bags, the cost, and the two-inch top-up figure for beds that already exist.', 'The honest alternatives arrive at volume: landscape yards sell by the cubic yard at a fraction of bagged pricing - one yard covers about eighteen bags - and established beds skip the reset entirely in favor of a two-inch compost top-up that feeds the soil web better than replacement ever does.'], 'howto': ['Measure inside the frame, length by width, and pick the depth.', 'Twelve inches suits tomatoes and roots; six is fine for lettuce.', 'Past six bags, call a landscape yard and price a cubic-yard delivery.'], 'faqs': [('How much soil do I need for a 4x8 raised bed?', 'At 12 inches deep, 32 cubic feet - about 22 of the 1.5 cubic foot bags. Six inches deep halves it to 16 cubic feet. The calculator prices either depth from your dimensions.'), ('How many bags of soil for a raised bed?', 'Divide total cubic feet by 1.5 for standard bags and round up for settling. Past about six bags, a landscape yard delivery by the cubic yard costs a fraction of the bagged route.'), ('What depth does a raised bed need?', 'Six inches runs lettuce, herbs and greens; twelve covers tomatoes, peppers and root crops; deeper beds mostly buy drainage and root-run for the ambitious. Deeper than your plants need is money spent on soil.'), ('Do I need to replace raised bed soil every year?', 'No - top up with two inches of compost each spring instead. Replacement dumps a functioning soil web and costs the most; the calculator shows the top-up figure next to the full reset for the comparison.')]})
    pages.append({'slug': 'super-bowl-squares-calculator', 'title': 'Super Bowl Squares Calculator - Pool, Payouts and the Split', 'h1': 'Super Bowl Squares Calculator', 'desc': 'Square price times 100 gives the pool, and the payout split by quarter shows exactly what each winner collects - with the house-cut rule. Free, no sign-up.', 'category': 'calculator', 'keyword': 'super bowl squares calculator payout split pool', 'tool': 'squares', 'args': {}, 'intro': ['Enter the price per square and pick a payout split. The calculator totals the 100-square pool and shows what each quarter winner collects - including the final-score payout under the classic 10/30/40/20 format.', 'The format that keeps friendships: draw numbers only after every square is sold, pay out everything - the house cut is what turns a game into a grudge - and remember that 0, 3, 4 and 7 win quarters far more than lucky 2 or 5, because football scoring does arithmetic in field goals and touchdowns.'], 'howto': ['Set the square price - 25 dollars makes a 2,500 pool.', 'Pick the payout split; the final quarter usually weighs most.', 'Draw numbers after the grid fills, never before.'], 'faqs': [('How do Super Bowl squares payouts work?', 'The 100-square pool pays four winners - one per quarter under your chosen split. The classic format pays 10/30/40/20, weighting the final score; even 25s across the quarters keeps every score change exciting.'), ('What are the best numbers in a squares pool?', '0, 7, 3 and 4 dominate, in that order - football scores move in sevens and threes, so squares ending in those digits hit quarters far more often. A 2-2 square is a lottery ticket; 0-0 is practically an investment.'), ('When should numbers be drawn for squares?', 'After every square is sold. Drawing numbers first lets people buy the good combinations and turns a fun pool into a race - the redraw-after-fill convention is what keeps it fair.'), ('Should the pool organizer keep a cut?', 'No - the standard format pays out the entire pool. The organizer keeps their full square like everyone else; a house cut is the fastest way to run the last squares pool your group ever does.')]})
    pages.append({'slug': 'spring-break-budget-calculator', 'title': 'Spring Break Budget Calculator - Per Person Cost, All In', 'h1': 'Spring Break Budget Calculator', 'desc': 'Flights, shared lodging, days and the daily food-and-fun line give the per-person cost, the group total and the daily burn. Free, no sign-up.', 'category': 'calculator', 'keyword': 'spring break budget calculator cost per person college', 'tool': 'springbreak', 'args': {}, 'intro': ['Enter the traveler count, flights, the lodging total, days on the ground and the daily food-and-fun line. The calculator gives the per-person all-in cost, the whole-group total, and the daily burn rate.', 'The booking window is the money lever - January prices for March trips run visibly cheaper than the February panic - and the lodging split is where the group math lives: the fourth traveler is the one who makes the rental work. Groceries for breakfasts and a cooler for lunches cut the food line roughly in half without touching the fun.'], 'howto': ['Flights first - they are the line that moves fastest.', 'Split the lodging by heads, not by rooms.', 'Set the food line honestly; the cooler is the budget cheat code.'], 'faqs': [('How much does spring break cost per person?', 'A typical flight-plus-rental trip runs 700-1,200 per person for five days depending on destination and group size - the rental split and the food line are where the range lives. The calculator prices your exact plan.'), ('When should I book spring break flights?', 'January. Leisure routes price low while demand is planning-stage and spike through February - the same seat that is 350 in January runs 500 at the panic window.'), ('How do groups split vacation costs fairly?', 'Split lodging by heads, track shared groceries in a single pot, and transfer individual shares within a week of booking. One person floats, everyone repays fast - the deposit conversation before booking beats the spreadsheet after.'), ('How do students save on spring break?', 'The fourth traveler halves the lodging; groceries for breakfast and lunch cut the food line about in half; and traveling one week off-peak moves every price down a tier without changing the trip.')]})
    pages.append({'slug': 'tax-refund-planner', 'title': 'Tax Refund Planner - The 70/30 Split That Saves Real Interest', 'h1': 'Tax Refund Planner', 'desc': 'Your refund split between the highest-APR card, the emergency fund and a guilt-free fun share - with the interest saved and the phishing warning. Free, no sign-up.', 'category': 'calculator', 'keyword': 'what to do with tax refund calculator split savings debt', 'tool': 'refundplan', 'args': {}, 'intro': ['Enter your expected refund, the APR on your highest card, and the fun share you can live with. The calculator splits the rest 70/30 between the card and the emergency fund and shows the interest the card payment saves this year.', 'The order is not moral, it is mathematical: debt first because the interest saving is a guaranteed return, emergency fund second because it is what keeps the next refund from also going to a card. The pro move is withholding tuning - a refund is an interest-free loan you gave the government all year.'], 'howto': ['Refund estimate from your filing software, the day it lands.', 'Enter the APR on your highest-rate card - the guaranteed-return rate.', 'Keep a fun share; budgets with zero fun do not survive February.'], 'faqs': [('What should I do with my tax refund?', 'The standard honest order: high-interest debt first (the interest saved is a guaranteed return), emergency fund second, and a planned fun share so the budget survives February. The calculator prices the split at your numbers.'), ('Is a tax refund bad for your finances?', 'A big refund means you lent the government money interest-free all year. It feels like a bonus but it was your take-home; adjusting withholding converts next year refund into monthly cash flow - the refund-happy habit is quietly expensive.'), ('How much of my refund should go to savings?', 'Whatever is left after high-APR debt: the emergency fund is the second priority because it prevents the next borrowing. Even 500 dollars in the buffer changes how the next car repair feels.'), ('Are tax refund scams common?', 'Refund season is phishing season - fake IRS calls, texts and refund-advance offers spike. The IRS does not call, text or email first, ever, and no legitimate service needs your full return by chat.')]})
    pages.append({'slug': 'wedding-budget-calculator', 'title': 'Wedding Budget Calculator - Total, Per Guest and the Guest-Count Lever', 'h1': 'Wedding Budget Calculator', 'desc': 'Guests, catering, bar and flat costs give the real total with a 10 percent buffer - and the guest-count math that saves more than any vendor negotiation. Free, no sign-up.', 'category': 'calculator', 'keyword': 'wedding budget calculator cost per guest average wedding cost', 'tool': 'wedding', 'args': {}, 'intro': ['Enter the guest count, catering per head, the bar package and everything flat - venue, photo, attire, flowers. The calculator totals it with the 10 percent buffer every wedding needs, prices each guest all-in, and shows what trimming the list actually saves.', 'The lever is the guest list, full stop: every guest costs their plate plus bar plus a share of everything flat, so cutting ten people saves more than any negotiation with a vendor. The honest context - the national average lands past thirty thousand - is a fact to see early, not a target to chase.'], 'howto': ['Guest count first - it multiplies everything else on the page.', 'Price catering and the bar per head from a real quote or two.', 'Roll venue, photo, attire and flowers into the flat total.'], 'faqs': [('What is the average wedding budget?', 'The national average lands past thirty thousand dollars for roughly a hundred guests - about 300 per guest all-in. Averages anchor badly though: the venue city and the guest count swing the number more than any other choice, and the calculator prices your plan instead of the average.'), ('What is the biggest cost lever in a wedding budget?', 'The guest list. Each guest adds their plate, their bar and their share of the flat costs - commonly 110-150 dollars all-in - so ten fewer guests save more than most vendor haggling ever will.'), ('How much should the bar cost at a wedding?', 'Beer and wine with a signature cocktail reads generous and prices a fraction of a full premium bar, which can add 45 dollars per head. Over a hundred guests, the bar choice alone is a five-figure decision.'), ('Why add 10 percent to the wedding budget?', 'Day-of costs nobody prices in advance: vendor overtime, the extra table that appeared, the real meal count for the crew. The buffer turns those from crisis line-items into a rounding error - and unspent, it seeds the honeymoon.')]})
    pages.append({'slug': 'gutter-cleaning-cost-calculator', 'title': 'Gutter Cleaning Cost Calculator - Per Visit, Year and Guards Payoff', 'h1': 'Gutter Cleaning Cost Calculator', 'desc': 'Gutter feet, stories and debris load price each cleaning and the year - and answer the guards question with a real payoff math. Free, no sign-up.', 'category': 'calculator', 'keyword': 'gutter cleaning cost calculator price per linear foot', 'tool': 'gutter', 'args': {}, 'intro': ['Enter the gutter run, your story count, the debris load and how many cleanings a year you schedule. The calculator prices each visit, the year, and - the question everyone actually has - how many years until gutter guards pay for themselves.', 'The cleaning is cheap; the skip is what costs. A clogged downspout is the actual villain, dumping water at the foundation and rotting the fascia quietly for a season. Guards reduce cleaning to inspection rather than eliminating it, and the payoff math says honestly whether they are worth it for your story count.'], 'howto': ['Measure the gutter run along the roofline, corners included.', 'Two stories and up: the ladder rule makes hiring the sensible default.', 'Heavy tree cover is why the fall cleaning exists.'], 'faqs': [('How much does gutter cleaning cost?', 'The national average runs about a dollar per linear foot, scaled up for stories and heavy debris - a typical 180-foot single-story home lands near 180 dollars a visit, twice a year in spring and fall.'), ('How often should gutters be cleaned?', 'Twice a year covers most homes - spring and fall. Heavy tree cover pushes it to three; homes with no trees over the roof can stretch to one. The clogged downspout, not the gutter trough, is the failure to prevent.'), ('Are gutter guards worth the money?', 'They reduce cleaning to an inspection, not eliminate it - fine debris still gets through. At 7-12 dollars a foot installed, the payoff against yearly cleanings runs years; the calculator prices it for your story count and tree cover.'), ('Can I clean gutters myself?', 'Single story with a stable ladder, yes - gloves and a scoop, and never overreach. Two stories and up is where hiring stops being optional: most gutter injuries are ladder injuries, and the cleaning costs less than the emergency room copay.')]})
    pages.append({'slug': 'air-purifier-size-calculator', 'title': 'Air Purifier Size Calculator - The CADR Number That Matters', 'h1': 'Air Purifier Size Calculator', 'desc': 'Room size and your reason for buying give the CADR to look for on the seal - allergies double it, smoke more - plus the marketing number to ignore. Free, no sign-up.', 'category': 'calculator', 'keyword': 'air purifier size calculator what size cadr room', 'tool': 'airpur', 'args': {}, 'intro': ['Enter the room area and why you are buying - dust, allergies, or smoke. The calculator gives the CADR number to look for on the certification seal, and the marketing square-footage claim to ignore.', 'CADR is the only spec that survives contact with physics: the marketing room-size numbers assume one lazy air change an hour, while allergies want four or five - which is why the allergy version of this calculator doubles the machine. The room that matters most is the bedroom, because eight hours of breathing is the longest exposure anyone gets.'], 'howto': ['Measure the room the purifier will live in, door closed.', 'Pick the honest reason - allergies and smoke run bigger machines.', 'Buy the certified seal, not the square-footage headline.'], 'faqs': [('What size air purifier do I need for my room?', 'Look for a CADR around two-thirds of your square footage for general air, doubled for allergies, more for smoke. A 300-square-foot bedroom wants roughly CADR 300 for allergy season - the calculator prices your room and reason.'), ('What does CADR mean on air purifiers?', 'Clean Air Delivery Rate - the certified cubic-feet-per-minute of filtered air, tested on dust, pollen and smoke. It is the only number verified by an independent standard; everything else on the box is marketing geometry.'), ('Why does the marketing claim a bigger room than the CADR suggests?', 'Room-size claims assume one air change per hour; allergy guidance wants four or five. Same machine, different math - the calculator runs the honest version for your reason.'), ('Where should I run an air purifier?', 'The bedroom first - eight hours of breathing is the longest exposure of the day - with the door closed so the sizing holds. Run it low at night for noise, high when you return home, and replace filters on schedule.')]})
    pages.append({'slug': 'lawn-fertilizer-calculator', 'title': 'Lawn Fertilizer Calculator - Pounds Per Feeding and Bags a Year', 'h1': 'Lawn Fertilizer Calculator', 'desc': 'Lawn size, the bag label rate and the holiday rhythm give pounds per feeding, bags a year and the cost - with the soil-test note that saves a feeding. Free.', 'category': 'calculator', 'keyword': 'lawn fertilizer calculator how much fertilizer per square foot', 'tool': 'lawnfert', 'args': {}, 'intro': ['Enter your lawn size, the application rate printed on the bag, how many feedings a year, and the bag price. The calculator gives pounds per feeding, bags for the year, and the cost.', 'The rate comes off the bag label because it is calibrated to the nitrogen number - and nitrogen is the one that burns: more product does not mean greener, it means stripes. The holiday rhythm is the memorization trick for cool-season lawns, and the county extension soil test costs about fifteen dollars and often deletes a feeding entirely.'], 'howto': ['Measure the lawn - guess high on the unofficial dirt patches.', 'The bag label rate is printed with the N-P-K numbers.', 'Memorial Day, July 4, Labor Day, Halloween - that is the rhythm.'], 'faqs': [('How much fertilizer do I need per square foot?', 'Bag labels rate applications in pounds per 1000 square feet - commonly 3 to 4 pounds for lawn products. The calculator scales that to your actual lawn and counts the year in bags.'), ('How often should I fertilize my lawn?', 'Cool-season lawns do well on four feedings a year, memorized as the holidays: Memorial Day, July 4, Labor Day and Halloween - each landing when the grass is actually growing. Five works with irrigation; two is the honest minimum.'), ('What happens if I use too much fertilizer?', 'Nitrogen burns - literal brown stripes where the spreader overlapped - plus runoff that feeds algae downstream. The label rate is a ceiling, not a suggestion; more product means stripes, not green.'), ('Do I need a soil test before fertilizing?', 'The county extension soil test costs about fifteen dollars and reports what the lawn actually lacks - it often deletes a feeding entirely or swaps the product, which pays for the test the first season.')]})
    pages.append({'slug': 'saline-rinse-calculator', 'title': 'Saline Rinse Calculator - Salt and Baking Soda for Any Bottle', 'h1': 'Saline Rinse Calculator', 'desc': 'Water volume gives the exact salt and baking soda for a sinus rinse - the pharmacy-packet recipe at pennies, with the boiled-water rule first. Free, no sign-up.', 'category': 'calculator', 'keyword': 'saline rinse recipe calculator neti pot salt amount', 'tool': 'saliner', 'args': {}, 'intro': ['Pick your rinse bottle size and get the exact non-iodized salt and baking soda - the same pharmacy-standard packet recipe at a few cents per rinse instead of a dollar.', 'The safety rule comes first because it is the only fatal one on the page: the water must be boiled and cooled or distilled, never straight from the tap. During allergy season a daily rinse after being outside clears pollen before it sets up inflammation - the best evidence-to-cost ratio on the allergy shelf.'], 'howto': ['Boil the water a minute and cool it, or use distilled - always.', 'Weigh the salt and soda; non-iodized salt only.', 'Rinse daily after outdoor exposure in pollen season.'], 'faqs': [('How much salt do I put in a sinus rinse?', 'About 9.4 grams of non-iodized salt per liter - 2.25 grams in a 240 ml squeeze bottle - plus baking soda to buffer. The calculator scales it to your bottle exactly, matching the commercial packet.'), ('Can I use tap water for a nasal rinse?', 'Never straight - tap, lake and shower water carry a rare but fatal amoeba risk. Boil for a minute and cool, or use distilled. This is the one rule on the page with no exceptions and no home remedies.'), ('Why does my sinus rinse sting?', 'Iodized table salt or missing buffer: iodine and anti-caking agents irritate, and the baking soda is what matches your body pH so the rinse feels like nothing. Use pickling or canning salt plus the soda.'), ('How often can I rinse my sinuses?', 'Daily during allergy season is standard and safe with clean water - rinse after outdoor exposure to clear pollen before it inflames. Skip when fully blocked; forcing through creates pressure without benefit.')]})
    pages.append({'slug': 'rain-barrel-calculator', 'title': 'Rain Barrel Calculator - Gallons Harvested From Your Roof', 'h1': 'Rain Barrel Calculator', 'desc': 'Roof area times rainfall gives the gallons one inch of rain harvests, how fast the barrels overflow, and the season total - with the mosquito rule. Free, no sign-up.', 'category': 'calculator', 'keyword': 'rain barrel calculator how much water from roof rain harvest', 'tool': 'rainbarrel', 'args': {}, 'intro': ['Enter the roof area feeding your downspout and how many 55-gallon barrels you run. The calculator shows the gallons one inch of rain harvests - hundreds on an ordinary roof - how fast they overflow, and the season total.', 'The shock is the point: a modest rain moves hundreds of gallons off your roof. The two rules that keep the barrel a blessing: a screened self-closing lid so mosquitoes cannot breed, and an overflow plan that routes water to garden beds instead of the foundation.'], 'howto': ['Roof area is footprint, not slope - pitch does not change harvest.', 'One inch of rain yields about 0.62 gallons per square foot.', 'Raise the barrel on blocks for gravity pressure at the spigot.'], 'faqs': [('How much water comes off a roof in rain?', 'About 0.62 gallons per square foot per inch of rain - one inch on a 1,200 square foot roof is roughly 750 gallons. Even one 55-gallon barrel fills several times over in a modest shower.'), ('Is rainwater good for the garden?', 'Better than most tap water - soft, neutral pH, no chlorine. Plants visibly prefer it, which is why the barrel pays for itself in plant health before the water bill notices.'), ('Do rain barrels attract mosquitoes?', 'Only if the water sits open. A screened, self-closing lid makes breeding impossible - the one rule that is non-negotiable, and the overflow hose should leave the barrel area too.'), ('Are rain barrels legal?', 'Most places yes; a few states carried historic restrictions that have mostly been repealed with incentives instead. Check your local rules once - the calculator handles the math, the statute needs one search.')]})
    pages.append({'slug': 'grass-seed-calculator', 'title': 'Grass Seed Calculator - Pounds for Bare Patches and Overseeding', 'h1': 'Grass Seed Calculator', 'desc': 'Patch size times the seeding rate gives pounds of seed, the cost, sprout timing and the first-mow rule - with the crabgrass conflict named honestly. Free, no sign-up.', 'category': 'calculator', 'keyword': 'grass seed calculator how much seed per square foot bare patch', 'tool': 'grassseed', 'args': {}, 'intro': ['Enter the bare patch size, the seeding style - bare ground wants about 5 pounds per 1000 square feet, overseeding half that - and your seed price. The calculator gives pounds, cost, sprout timing and the first-mow rule.', 'Two rules decide patch success: seed-to-soil contact (rake it in so it stops being bird food) and twice-daily watering until sprouts show. The honest calendar note: spring seeding fights crabgrass pre-emergent, which kills grass seed as enthusiastically as weeds - you cannot have both the barrier and the patch.'], 'howto': ['Measure the bare spots honestly - they always run bigger.', 'Rake the seed in lightly; contact with soil is everything.', 'Water twice a day, ten minutes, until the green shows.'], 'faqs': [('How much grass seed do I need per square foot?', 'Bare ground wants about 5 pounds per 1000 square feet; overseeding a thin lawn takes half that. The calculator scales the rate to your patch and prices it.'), ('When should I plant grass seed?', 'Fall is the better season for cool-season grass on every measure - warm soil, cool air, fewer weeds. Spring works but competes with crabgrass pre-emergent, which kills grass seed along with the weeds: pick one.'), ('How long does grass seed take to sprout?', 'Five to fourteen days depending on variety and warmth, with the first mow at three inches - about three to four weeks in. Daily watering until sprouts show is the non-negotiable part.'), ('Why did my grass seed not grow?', 'Almost always seed-to-soil contact or water: seed sitting on top of old thatch is bird food, and a single missed day of watering at sprout time kills the crop. Rake in, water twice daily, and patience does the rest.')]})
    pages.append({'slug': 'deck-stain-calculator', 'title': 'Deck Stain Calculator - Gallons, Cost and Brushing Hours', 'h1': 'Deck Stain Calculator', 'desc': 'Deck area, railing and coats give gallons of stain, the cost and the brushing hours - with the prep rule that decides whether the job lasts. Free, no sign-up.', 'category': 'calculator', 'keyword': 'deck stain calculator how much stain gallons per square foot', 'tool': 'deckstain', 'args': {}, 'intro': ['Enter the deck floor area, the railing run, coats and your stain price. The calculator gives gallons - stain covers about 350 square feet per gallon per coat - plus cost and honest brushing hours.', 'The prep is what decides whether the job lasts its two-to-three-year cycle: pressure-wash first, because stain over gray dead fibers peels with them, and the forecast needs two dry days either side. Transparent shows grain and fades fastest; solid hides and lasts longest.'], 'howto': ['Measure the floor and add the railing run - it drinks stain too.', 'Two coats on bare or gray wood, one on a recent refresh.', 'Pressure-wash first and wait two dry days after.'], 'faqs': [('How much stain do I need for my deck?', 'About a gallon per 350 square feet per coat, with rough bare wood drinking more. The calculator adds the railing run - rails and balusters can add a third again to the job.'), ('How often should a deck be stained?', 'Every two to three years for transparent stains, three to four for solid color - sun and foot traffic decide more than the calendar. When water soaks in instead of beading, the deck is asking.'), ('Can I stain over old stain?', 'Only over sound, clean stain of the same opacity family - peeling or gray areas need pressure-washing and stripping first, or the new coat peels with the old within a season.'), ('Is it better to spray or brush deck stain?', 'A sprayer is three times faster but pushes stain into back-brushing anyway, so most DIYers brush by pad and win the control. Either way the two-dry-day forecast matters more than the applicator.')]})
    pages.append({'slug': 'compost-ratio-calculator', 'title': 'Compost Ratio Calculator - Browns for Your Kitchen Scraps Bucket', 'h1': 'Compost Ratio Calculator', 'desc': 'Kitchen scraps per week give the browns volume that keeps the pile composting instead of rotting - bin size, timing and the smell diagnostics. Free, no sign-up.', 'category': 'calculator', 'keyword': 'compost ratio calculator browns greens kitchen scraps', 'tool': 'compostr', 'args': {}, 'intro': ['Enter what your kitchen scrap bucket collects in a week. The calculator gives the browns volume - two parts dry leaves and shredded cardboard per one part scraps - that keeps the pile composting instead of rotting.', 'Smell is the whole diagnostic: ammonia or sour means add browns and turn, silence means it is too dry. No meat, dairy or cooked food - those invite rats, not microbes - and the finished compost lands in two to three months turned weekly, or a patient season if you never turn it.'], 'howto': ['Weigh or estimate the weekly bucket - most kitchens run 2-4 gallons.', 'Collect browns: dead leaves, shredded cardboard, sawdust.', 'Layer as you go; the bin should smell like a forest floor.'], 'faqs': [('What is the right brown to green ratio for compost?', 'Two parts browns to one part greens by volume - dry leaves, straw and shredded cardboard against kitchen scraps and fresh clippings. The calculator sizes the browns for your bucket.'), ('Why does my compost smell bad?', 'Too wet, too green, or meat inside: the anaerobic smell means add browns and turn for air. A working pile smells like a forest floor - if you can smell it from the patio, the ratio needs carbon.'), ('What should never go in compost?', 'Meat, dairy, oils and cooked food attract rats; diseased plants and stubborn weeds carry through. Everything else plant-based is fair game, stickers removed.'), ('How long does compost take?', 'Two to three months with weekly turning; a static pile takes a season and almost no effort. Both produce the same dark crumbly end - the turning is a speed choice, not a quality one.')]})
